            ...
            (t.prototype = {
                ...
                _buildShape: function () {
                    ...
                    for (
                        ...
                        if (
                            e[m].type == U.CHART_TYPE_MAP &&
                            ((e[m] = this.reformOption(e[m])),
                            (i = e[m].mapType),
                            (s[i] = s[i] || {}),
                            (s[i][m] = !0),
                            (l[i] = l[i] || e[m].mapValuePrecision),
                            (this._scaleLimitMap[i] =
                                this._scaleLimitMap[i] || {}),
                            e[m].scaleLimit &&
                                p.merge(
                                    this._scaleLimitMap[i],
                            ...
                            (this._roamMap[i] = e[m].roam || this._roamMap[i]),
                            (null == this._hoverLinkMap[i] ||
                                this._hoverLinkMap[i]) &&
                                (this._hoverLinkMap[i] =
                                    e[m].dataRangeHoverLink),
                            (this._nameMap[i] = this._nameMap[i] || {}),
                            e[m].nameMap &&
                                p.merge(this._nameMap[i], e[m].nameMap, !0),
                            (this._activeMapType[i] = !0),
                            e[m].textFixed && p.merge(g, e[m].textFixed, !0),
                            e[m].geoCoord && p.merge(b, e[m].geoCoord, !0),
                            (this._selectedMode[i] =
                                this._selectedMode[i] || e[m].selectedMode),
                            (null == this._hoverable[i] ||
                                this._hoverable[i]) &&
                                (this._hoverable[i] = e[m].hoverable),
                            (null == this._clickable[i] ||
                                this._clickable[i]) &&
                                (this._clickable[i] = e[m].clickable),
                            (null == this._showLegendSymbol[i] ||
                                this._showLegendSymbol[i]) &&
                                (this._showLegendSymbol[i] =
                                    e[m].showLegendSymbol),
                                ...
                                for (var u in n[d])
                                    "value" != u
                                        ...
                                        : isNaN(n[d].value) ||
                                          (null == r[i][a].value &&
                                              (r[i][a].value = 0),
                                          (r[i][a].precision = Math.max(
                                              this.getPrecision(+n[d].value),
                                              r[i][a].precision
                                          )),
                                          (r[i][a].value += +n[d].value),
                                          (r[i][a].valueMap[m] = +n[d].value));
                    ...
                    for (var f in r) {
                        for (var c in r[f]) {
                            ...
                            null != k &&
                                (r[f][c].value =
                                    k.toFixed(
                                        null == l[f] ? r[f][c].precision : l[f]
                                    ) - 0);
                        }
                        (this._mapDataMap[f] = this._mapDataMap[f] || {}),
                            this._mapDataMap[f].mapData
                                ...
                                : y[f.replace(/\|.*/, "")].getGeoJson &&
                                  ((this._specialArea[f] =
                                      y[f.replace(/\|.*/, "")].specialArea ||
                                      this._specialArea[f]),
                                  y[f.replace(/\|.*/, "")].getGeoJson(
                                      this._mapDataCallback(f, r[f], s[f])
                                  ));
                    }
                },
                _mapDataCallback: function (t, i, n) {
                    ...
                    return function (o) {
                        a._isAlive &&
                            ...
                            a._buildMap(t, a._getProjectionData(t, o, n), i, n),
                            a._buildMark(t, n),
                ...
                _getProjectionData: function (e, t, i) {
                    ...
                    n = this._mapDataMap[e].hasRoam
                        ...
                        : this._getTransform(r, i, this._mapDataMap[e].rate);
                    var s,
                    ...
                    n.scale.x != l.scale.x ||
                    n.scale.y != l.scale.y
                        ? ((s = a.geoJson2Path(t, n, this._specialArea[e])),
                          (l = p.clone(n)))
                        : ((n = this._mapDataMap[e].transform),
                          (s = this._mapDataMap[e].pathArray)),
                        (this._mapDataMap[e].bbox = r),
                        (this._mapDataMap[e].transform = n),
                        (this._mapDataMap[e].lastTransform = l),
                        (this._mapDataMap[e].pathArray = s);
                    for (
                        var h = [n.left, n.top], m = 0, V = s.length;
                        V > m;
                        m++
                    )
                ...
                _getTransform: function (e, t, i) {
                    var n,
                        ...
                        V = this.zr.getWidth(),
                        U = this.zr.getHeight(),
                        d = Math.round(0.02 * Math.min(V, U));
                    for (var p in t)
                        (n = m[p].mapLocation || {}),
                            (o = n.x || o),
                            (s = n.y || s),
                    ...
                    (a = this.parsePercent(o, V)),
                        ...
                        (l =
                            null == l
                                ? V - a - 2 * d
                                : this.parsePercent(l, V)),
                        (h =
                            null == h
                                ? U - r - 2 * d
                                : this.parsePercent(h, U));
                    var c = e.width,
                        u = e.height,
                        y = l / i / c,
                        g = h / u;
                ...
                _buildMap: function (e, t, i, m) {
                    for (
                        ...
                        if (
                            ...
                            (g = [u]), (V = "");
                            for (
                                var I = 0, J = u.seriesIndex.length;
                                J > I;
                                I++
                            ) {
                        ...
                        switch (
                            (this.ecTheme.map && g.push(this.ecTheme.map),
                            g.push(U.map),
                            (b = v && !isNaN(y) ? v.getColor(y) : null),
                            (k.color =
                                k.color ||
                                b ||
                                this.getItemStyleColor(
                                    this.deepQuery(g, "itemStyle.normal.color"),
                                    u.seriesIndex,
                                    -1,
                                    u
                                ) ||
                            ...
                            (k.brushType = _.brushType = k.brushType || "both"),
                            (k.lineJoin = _.lineJoin = "round"),
                            (k._name = _._name = c),
                            (f = this.deepQuery(
                                g,
                            ...
                            (L._style = p.clone(L.style)),
                            (L.highlightStyle = p.clone(L.style)),
                            this.deepQuery(g, "itemStyle.emphasis.label.show")
                                ? ((L.highlightStyle.text = this.getLabelText(
                                      c,
                                      y,
                                      g,
                                      "emphasis"
                                  ...
                                  (L.highlightStyle.textFont = this.getFont(f)))
                                : (L.highlightStyle.color = "rgba(0,0,0,0)"),
                            (x = {
                                zlevel: this.getZlevelBase(),
                                z: this.getZBase(),
                                position: p.clone(k.position),
                            ...
                            null != k.scale && (x.scale = p.clone(k.scale)),
                            (L = new n(L)),
                            x.style.shapeType)
                        ) {
                            case "rectangle":
                        ...
                        ((this._selectedMode[e] &&
                            ...
                            u.selected !== !1) ||
                            u.selected === !0) &&
                            ((L.style = L.highlightStyle),
                            (x.style = x.highlightStyle)),
                            (L.clickable = x.clickable =
                                this._clickable[e] &&
                                (null == u.clickable || u.clickable)),
                            this._selectedMode[e] &&
                                ((this._selected[c] =
                                ...
                                (null == u.selectable || u.selectable) &&
                                    ((x.clickable = L.clickable = !0),
                                    (x.onclick = L.onclick =
                                        this.shapeHandler.onclick))),
                            this._hoverable[e] &&
                            (null == u.hoverable || u.hoverable)
                                ? ((L.hoverable = x.hoverable = !0),
                                  (x.hoverConnect = L.id),
                                  (L.hoverConnect = x.id))
                                : (L.hoverable = x.hoverable = !1),
                            d.pack(
                                L,
                                {
                                    name: V,
                ...
                _buildMark: function (e, t) {
                    ...
                    "none" == e && (i = [0, 0]);
                    for (var n in t)
                        (this._seriesIndexToMapType[n] = e),
                ...
                _findMapTypeByPos: function (e, t) {
                    ...
                    for (var s in this._mapDataMap)
                        if (
                            ((i = this._mapDataMap[s].transform),
                            i &&
                                this._roamMap[s] &&
                        ...
                        for (s in d)
                            if (d[s]) {
                                ...
                                if (V > 0) {
                                    if (
                                        ((r = 1.2),
                                        null != this._scaleLimitMap[s].max &&
                                            c.baseScale >=
                                                this._scaleLimitMap[s].max)
                                    )
                                        continue;
                                } else if (
                                    ((r = 1 / 1.2),
                                    null != this._scaleLimitMap[s].min &&
                                        c.baseScale <=
                                            this._scaleLimitMap[s].min)
                                )
                                    continue;
                                (c.baseScale *= r),
                                    (c.scale.x *= r),
                ...
                __onroamcontroller: function (e) {
                    ...
                    for (s in i)
                        this._mapDataMap[s] &&
                            this._activeMapType[s] &&
                            ((r = this._mapDataMap[s].transform),
                            (r.hasRoam = !0),
                            (r.left -= a),
                            (r.top -= n),
                            (this._mapDataMap[s].transform = r));
                    for (var l = 0, h = this.shapeList.length; h > l; l++)
                        (s = this.shapeList[l]._mapType),
                            i[s] &&
                                this._activeMapType[s] &&
                                ((r = this._mapDataMap[s].transform),
                                (this.shapeList[l].position[0] = r.left),
                                (this.shapeList[l].position[1] = r.top),
                    ...
                    for (var t, i, n = 0, a = this.shapeList.length; a > n; n++)
                        (t = this.shapeList[n]._mapType),
                            this._hoverLinkMap[t] &&
                                ...
                                ((i = d.get(this.shapeList[n], "value")),
                                null != i &&
                                    i >= e.valueMin &&
                                    i <= e.valueMax &&
                                    this.zr.addHoverShape(this.shapeList[n]));
                },
                onclick: function (e) {
                    if (
                        this.isClick &&
                                ...
                                if (
                                    ...
                                    for (var r = 0; n > r; r++)
                                        this.shapeList[r].style._name == o &&
                                            ...
                                            ((this.shapeList[r].style =
                                                this.shapeList[r]._style),
                                            this.zr.modShape(
                                                this.shapeList[r].id
                                            ));
                ...
                getPosByGeo: function (e, t) {
                    ...
                    return (
                        (i[0] += this._mapDataMap[e].transform.left),
                ...
                onbeforDispose: function () {
                    (this._isAlive = !1),
                        ...
                        this.messageCenter.unbind(
                            U.EVENT.ROAMCONTROLLER,
                            this._onroamcontroller
                        ),
                        this.messageCenter.unbind(
                            U.EVENT.DATA_RANGE_HOVERLINK,
                            this._ondrhoverlink
                        );
                },
            }),
                ...
                (s.prototype = {
                    ...
                    buildPath: function (e, t) {
                        var i = t.path,
                            ...
                            a = t.y || 0;
                        t.pathArray =
                            t.pathArray || this.buildPathArray(i, n, a);
                        for (
                            var o = t.pathArray,
                                r = (t.pointList = []),
                                s = [],
                            ...
                            for (
                                var m = o[l].points, V = 0, U = m.length;
                                U > V;
                                V += 2
                            )
                                s.push([m[V], m[V + 1]]);
                ...
                (t.prototype = {
                    ...
                    _buildShape: function () {
                        if (
                            ...
                            for (
                                var e = 0, t = this.shapeList.length;
                                t > e;
                                e++
                            )
                        ...
                        for (var y = 0; s > y; y++)
                            (e = r[y]),
                                ...
                                this.dataRangeOption.selectedMode &&
                                    ((t.clickable = !0),
                                    (t.onclick = this._dataRangeSelected)),
                                    ...
                                    ((i = {
                                        ...
                                        style: {
                                            ...
                                            color: this._selectedMap[y]
                                                ? this.dataRangeOption.textStyle
                                                      .color
                                                : "#ccc",
                                            text: r[y],
                                            textFont: l,
                    ...
                    _buildGradient: function () {
                        ...
                        for (
                            var p = e("zrender/tool/color"),
                                ...
                                u = [],
                                y = 0,
                                g = this.dataRangeOption.color.length;
                            g > y;
                            y++
                        )
                    ...
                    _bulidHandle: function () {
                        ...
                        "horizontal" == this.dataRangeOption.orient
                            ...
                            (this._startShape.zlevel = this._endShape.zlevel =
                                this.getZlevelBase()),
                            (this._startShape.z = this._endShape.z =
                                this.getZBase() + 1),
                            (this._startShape.draggable =
                                this._endShape.draggable =
                                    !0),
                            (this._startShape.ondrift = this._endShape.ondrift =
                                this._ondrift),
                            (this._startShape.ondragend =
                                this._endShape.ondragend =
                                    this._ondragend),
                            ...
                            (this._startShape.style.textBaseline =
                                this._endShape.style.textBaseline =
                                    "middle"),
                            (this._startShape.style.width =
                                this._endShape.style.width =
                                    0),
                            (this._startShape.style.height =
                                this._endShape.style.height =
                                    0),
                            (this._startShape.style.textPosition =
                                this._endShape.style.textPosition =
                                    "specific"),
                    ...
                    _buildBackground: function () {
                        var e = this.reformCssArray(
                            this.dataRangeOption.padding
                        );
                        this.shapeList.push(
                            new a({
                                zlevel: this.getZlevelBase(),
                                ...
                                style: {
                                    ...
                                    height:
                                        ...
                                        e[2],
                                    brushType:
                                        0 === this.dataRangeOption.borderWidth
                                            ? "fill"
                                            : "both",
                                    color: this.dataRangeOption.backgroundColor,
                                    strokeColor:
                                        this.dataRangeOption.borderColor,
                    ...
                    _getItemGroupLocation: function () {
                        ...
                        if ("horizontal" == this.dataRangeOption.orient) {
                            if (
                                ...
                                o =
                                    ...
                                    (this.dataRangeOption.text &&
                                    "undefined" !=
                                        typeof this.dataRangeOption.text[0]
                                        ? h.getTextWidth(
                                              this.dataRangeOption.text[0],
                                              s
                                          ) + this._textGap
                                    ...
                                    (this.dataRangeOption.text &&
                                    "undefined" !=
                                        typeof this.dataRangeOption.text[1]
                                        ? h.getTextWidth(
                                              this.dataRangeOption.text[1],
                                              s
                                          ) + this._textGap
                        ...
                        if (this.dataRangeOption.calculable) {
                            var g =
                                Math.max(
                                    h.getTextWidth(this.dataRangeOption.max, s),
                    ...
                    _syncHandleShape: function () {
                        ...
                        "horizontal" == this.dataRangeOption.orient
                            ? ((this._startShape.style.x =
                                  this._fillerShape.style.x),
                              (this._startMask.style.width =
                                  this._startShape.style.x - e),
                              (this._endShape.style.x =
                                  this._fillerShape.style.x +
                                  this._fillerShape.style.width),
                              (this._endMask.style.x = this._endShape.style.x),
                              (this._endMask.style.width =
                                  e + i - this._endShape.style.x),
                              (this._range.start = Math.ceil(
                                  100 -
                                      ((this._startShape.style.x - e) / i) * 100
                              )),
                              (this._range.end = Math.floor(
                                  100 - ((this._endShape.style.x - e) / i) * 100
                              )))
                            : ((this._startShape.style.y =
                                  this._fillerShape.style.y),
                              (this._startMask.style.height =
                                  this._startShape.style.y - t),
                              (this._endShape.style.y =
                                  this._fillerShape.style.y +
                                  this._fillerShape.style.height),
                              (this._endMask.style.y = this._endShape.style.y),
                              (this._endMask.style.height =
                                  t + n - this._endShape.style.y),
                              (this._range.start = Math.ceil(
                                  100 -
                                      ((this._startShape.style.y - t) / n) * 100
                              )),
                              (this._range.end = Math.floor(
                                  100 - ((this._endShape.style.y - t) / n) * 100
                              ))),
                            this._syncShape();
                    },
                        ...
                        "horizontal" == this.dataRangeOption.orient
                            ? ((t = this._startShape.style.x),
                              ...
                              e.id == this._startShape.id && t >= i
                                  ...
                                  : e.id == this._endShape.id &&
                                    t >= i &&
                                    ((t = i), (this._startShape.style.x = t)),
                              (this._fillerShape.style.x = t),
                              (this._fillerShape.style.width = i - t),
                              (this._startMask.style.width = t - n),
                              (this._endMask.style.x = i),
                              (this._endMask.style.width = n + o - i),
                              (this._range.start = Math.ceil(
                                  100 - ((t - n) / o) * 100
                              )),
                              (this._range.end = Math.floor(
                            ...
                            : ((t = this._startShape.style.y),
                              ...
                              e.id == this._startShape.id && t >= i
                                  ...
                                  : e.id == this._endShape.id &&
                                    t >= i &&
                                    ((t = i), (this._startShape.style.y = t)),
                              (this._fillerShape.style.y = t),
                              (this._fillerShape.style.height = i - t),
                              (this._startMask.style.height = t - a),
                              (this._endMask.style.y = i),
                              (this._endMask.style.height = a + r - i),
                              (this._range.start = Math.ceil(
                                  100 - ((t - a) / r) * 100
                              )),
                              (this._range.end = Math.floor(
                    ...
                    _syncShape: function () {
                        (this._startShape.position = [
                            ...
                            (this._endShape.position = [
                                this._endShape.style.x -
                                    this._endShape.style._x,
                                this._endShape.style.y -
                                    this._endShape.style._y,
                            ]),
                    ...
                    __dataRangeSelected: function (e) {
                        ...
                        this._useCustomizedSplit()
                            ? ((n = this._splitList[i].max),
                              (a = this._splitList[i].min))
                            : ((n =
                        ...
                        if (this.dataRangeOption.calculable) {
                            ...
                            (n =
                                "horizontal" == this.dataRangeOption.orient
                                    ? (1 -
                                          (l.getX(e.event) -
                                              this._calculableLocation.x) /
                                              this._calculableLocation.width) *
                                      a
                                    : (1 -
                                          (l.getY(e.event) -
                                              this._calculableLocation.y) /
                        ...
                        if (
                            ...
                            t < this.dataRangeOption.min
                                ...
                                (this._indicatorShape.style.text =
                                    this._textFormat(e.value)),
                                (this._indicatorShape.style.color =
                                    this.getColor(t)),
                    ...
                    _buildColorList: function (e) {
                        if (
                            ((this._colorList = m.getGradientColors(
                        ...
                        if (this._useCustomizedSplit())
                            for (
                                var o = this._splitList, a = 0, t = o.length;
                                t > a;
                                a++
                            )
                    ...
                    _buildSplitList: function () {
                        if (this._useCustomizedSplit())
                            for (
                                var e = this.dataRangeOption.splitList,
                                    t = (this._splitList = []),
                                    i = 0,
                                    n = e.length;
                                n > i;
                                ...
                                if (!a || (null == a.start && null == a.end))
                                    throw new Error(
                                        "Empty item exists in splitList!"
                                    );
                                var o = { label: a.label, color: a.color };
                                (o.min = a.start),
                                    (o.max = a.end),
                                    o.min > o.max &&
                                        (o.min = [o.max, (o.max = o.min)][0]),
                    ...
                    getColor: function (e) {
                        ...
                        if (this._useCustomizedSplit()) {
                            for (
                                var i = this._splitList, n = 0, a = i.length;
                                a > n;
                                n++
                            )
                ...
                (t.prototype = {
                    ...
                    _buildItem: function () {
                        this.shapeList.push(this._getDirectionShape("up")),
                            this.shapeList.push(
                                this._getDirectionShape("down")
                            ),
                            this.shapeList.push(
                                this._getDirectionShape("left")
                            ),
                            this.shapeList.push(
                                this._getDirectionShape("right")
                            ),
                            this.shapeList.push(this._getScaleShape("scaleUp")),
                            this.shapeList.push(
                                this._getScaleShape("scaleDown")
                            );
                    },
        ...
        return (
            (e.prototype = {
                getCanvas: function (e, t, a) {
                    ...
                    for (
                        var h = l.getContext("2d"), m = e.length, V = 0;
                        m > V;
                        ++V
                    ) {
                        var U = e[V],
                    ...
                    for (
                        var y = h.getImageData(0, 0, l.width, l.height),
                            g = y.data,
                            m = g.length / 4;
                        m--;
                    ...
                    if (!this._gradientPixels) {
                        ...
                        for (
                            var i = t.getContext("2d"),
                                a = i.createLinearGradient(0, 0, 0, e),
                                o = this.option.gradientColors.length,
                                r = 0;
                            o > r;
                            ++r
                        )
                            "string" == typeof this.option.gradientColors[r]
                                ? a.addColorStop(
                                      (r + 1) / o,
                                      this.option.gradientColors[r]
                                  )
                                : a.addColorStop(
                                      this.option.gradientColors[r].offset,
                                      this.option.gradientColors[r].color
                                  );
                        (i.fillStyle = a),
                            i.fillRect(0, 0, 1, e),
                            (this._gradientPixels = i.getImageData(
                                0,
                                0,
                                1,
                                e
        ...
        function (e) {
            ...
            function s(e, t) {
                ...
                i && "none" != i
                    ...
                    : n &&
                      "none" != n &&
                      ((e.strokeColor = n), (e.brushType = "stroke")),
                    a && "none" != a && (e.lineWidth = parseFloat(a)),
                    o && "none" != o && (e.opacity = parseFloat(o));
            }
            function l(e) {
                for (
                    var t = r(e).replace(/,/g, " ").split(/\s+/), i = [], n = 0;
                    n < t.length;
    ...
    define("echarts/util/projection/normal", [], function () {
        ...
        function i(e, i, n) {
            ...
            (n = n || {}),
                ...
                (o.offset = i.offset);
            for (
                var r, s, l, h = e.features, m = [], V = 0, U = h.length;
                U > V;
                V++
            )
        ...
        var o = {
                formatPoint: function (e) {
                    return [
                        (e[0] < -168.5 && e[1] > 63.8 ? e[0] + 360 : e[0]) +
                            168.5,
                        90 - e[1],
                    ];
                },
            ...
            features: [
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@RBX@RFFCBFU@aK@WA}CCJGAEFkCBRFD@JB@@N",
                        ],
            ...
            features: [
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@óóóυóôƥ@ŏóóə@ƧŋƩŌρóɛŐóʶѶʴƥʶ̎ôƨɞ@óŎɜŌ̎̍φƧŋƨʵ",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@ôôɜ@ƨöɚôôôɚŏ@óƥ@@ȁƦƧɜ@óƧƨƥ@ƧóəН̏óѷɜ@ŎƦƨóО",
                        ],
            ...
            features: [
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@Ș°ÇīXŃŗ@ȍlkƒlUŁ±īĵKō¼VÇôXĸ¯@ťê°źk¤x@Ĭ",
                        ],
            ...
            features: [
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@NEHFLAFDHDPEAMZUHQQ]IMKJG@EPERABHBGRUCCNGV",
                        ],
            ...
            features: [
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@d@hZNFdcLYXKRCtCMOFSYEGHEAGEDMu@SKAAsx]GMTGt",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@J\\PNHEZBFEJELEL@BWGI^]FEkA@G]A[FDHUCMNEHJ^",
                        ],
            ...
            features: [
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@Ń˷ŢέΒȳiə˗ŧ»˙ϷСƛÐgȂү˰ñАîֶŖʼƗƂÉˌθаÂƿɨôǴɥȪďȨ̂",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@Ƭ¤ɱڂƂ۞uԖ{ֺ֪ظՠՎԮǆ˹ŖڑѕGçճƪŝϝǑE΅ʓΏuͷǝǱᡋъ͏࡚Ț",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@ۛįȹ׆ኞǛǦЮ̇̌ʱʞņѶ̀ĨǠξЪĀȀʤˮʘ̠F٘ә˩ȎӽǓͷĘɧСԳʵʳǁՉt՗µണ",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@ƫŹȳϞƵіwá΅χƙةŀǻ͹ЏơƄһ˵Л¡αǶ˽ςБſ^ϠؚҾɈϤûɲƞ܎MǦǼ࣒ʱ",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@ŀƞپIӾɏɜtƴ̕ҠhʡϐЮ̷̯ͿЍǼϫˡ¢ƱƵ͑½ŷȲˣťͳֻɏƆ§ʎjɬɍʦȲƚÞ͒óҜ",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@Ųάȿִӟ̲ҭĬ̯ʴĺĲ܄ƝఆƋଦЕƦƻԚƂ޶ǭʴ·Նșɓřвғŗıҏºصʎȵƍଢ଼ſ߳Юࣅ¡",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@೉ӯҳ˽ݳʑݡʆͨηܤɖैΠ۸ɟ஢ŗنrӊฤ¢ϊÕ˔ƊϴáÕʿΖџC؍Ąڍɂ̫ȅݳäйɢՓȈ̍",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@șիॊֵથٙᝓֹܣƵૉŮᚑˈࠠψᆧЪ๪ǎʘᄋȜ֨նౠŰಸ֭౨Ҝ੒ʃൌ҄ආÑ",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@ƥ˅̣Ŝǫ֓ɂĥɋřɛЄŖp͛нഉց෾ʔˢË¶ɞϼǠيŤɆzVˬCþƦɤ\\`·ŕŵhM",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@نЮՆߊ˼ڜعڪhǊ٤ܐƪςĻܢ̷ۚCКȕîС˒ӷ͕ࣗԛƙ߱ТҁÄŝǪࠛĉණÂ१ʳ",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@ÝαŌՕĩͩ۩aয়Ȟ٭ĂӛђଷŊયҼ߉Ю߿͆͜޼ՒϠΒȪڪʳࡔշҾť˰ЕٶǓۀσौȕঔć",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@ɧØ؁ͺѩ҈Ƨ̬Ĺت҆τĬɺƞǸɶpȜǂڦCɺ̛ǼΛʓƈɗṶɴ´ϹϹϛҗ«ʓȩˏ",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@ϛԩד۫۹Mᩧা͍̜̳К̳ҨǾ̖̲҈˚ƹǒΏϜΗкGߊɌࣴĴ݌ʼиÆ̚ƶӎKaE΋Aࡑ@ѫ",
                        ],
                ...
                },
                {
                    ...
                    geometry: {
                        type: "Polygon",
                        coordinates: [
                            "@@ղĚࡆٯ̺|ࡺ՟ڈҫӠֱχЉɸӇεՇॉұاǚғěޥΰ֫ԟҬÞլǾȈS࠸ɤࡺȾڦ",
                        ],
                        encodeOffsets: [[-59008, -30941]],
                    },
                },
