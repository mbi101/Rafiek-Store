...
define("ace/mode/html/saxparser", ["require", "exports", "module"], function (
    require,
    exports,
    module
) {
    ...
    })(
        {
            1: [
                function (_dereq_, module, exports) {
                    ...
                    ElementStack.prototype.popUntilTableScopeMarker =
                        function () {
                            while (!isTableScopeMarker(this.top)) this.pop();
                        };

                    ElementStack.prototype.popUntilTableBodyScopeMarker =
                        function () {
                            while (!isTableBodyScopeMarker(this.top))
                                this.pop();
                        };

                    ElementStack.prototype.popUntilTableRowScopeMarker =
                        function () {
                    ...
                    ElementStack.prototype.hasNumberedHeaderElementInScope =
                        function () {
                            for (
                    ...
                    ElementStack.prototype.furthestBlockForFormattingElement =
                        function (element) {
                    ...
                    ElementStack.prototype.remove_openElements_until =
                        function (callback) {
                            var finished = false;
                            var element;
                            while (!finished) {
                    ...
                    EntityParser.consumeEntity = function (
                        ...
                        if (ch == "#") {
                            ...
                            if (isDigit(ch)) {
                                ...
                                var replacement =
                                    this.replaceEntityNumbers(code);
                                if (replacement) {
                                    tokenizer._parseError(
                    ...
                    InputStream.prototype = {
                        ...
                        matchWhile: function (re) {
                            ...
                            if (m) {
                                if (
                                    !this.eof &&
                                    m[0].length == this.data.length - this.start
                                )
                                    throw InputStream.DRAIN;
                        ...
                        peek: function (n) {
                            ...
                            return this.data
                                .slice(
                                    this.start,
                                    Math.min(this.start + n, this.data.length)
                                )
                                .toString();
                        },
                        length: function () {
            ...
            4: [
                function (_dereq_, module, exports) {
                    ...
                    StackItem.prototype.isMathMLTextIntegrationPoint =
                        function () {
                            if (
                                this.namespaceURI ===
                                "http://www.w3.org/1998/Math/MathML"
            ...
            6: [
                function (_dereq_, module, exports) {
                    ...
                    CharacterBuffer.prototype.skipLeadingWhitespace =
                        function () {
                            while (
                    ...
                    CharacterBuffer.prototype.skipLeadingNonWhitespace =
                        function () {
                            while (
                                !isWhitespace(this.characters[this.current])
                            ) {
                    ...
                    CharacterBuffer.prototype.takeLeadingWhitespace =
                        function () {
                    ...
                    function TreeBuilder() {
                        ...
                        modes.initial.processDoctype = function (
                            ...
                            function publicIdStartsWith(string) {
                                return (
                                    publicId.toLowerCase().indexOf(string) === 0
                                );
                            }
                        };
                        ...
                        modes.inHead.processEOF = function () {
                            ...
                            if (
                                ["title", "style", "script"].indexOf(name) != -1
                            ) {
                                tree.parseError(
                        ...
                        modes.inBody.startTagRpRt = function (
                            ...
                            if (tree.openElements.inScope("ruby")) {
                                tree.generateImpliedEndTags();
                                if (
                                    tree.currentStackItem().localName != "ruby"
                                ) {
                                    tree.parseError("unexpected-start-tag", {
                                        name: name,
                                    });
                        ...
                        modes.inBody.startTagA = function (name, attributes) {
                            var activeA =
                                tree.elementInActiveFormattingElements("a");
                            if (activeA) {
                                tree.parseError(
                        ...
                        modes.inBody.startTagMath = function (
                            ...
                            tree.reconstructActiveFormattingElements();
                            attributes =
                                tree.adjustMathMLAttributes(attributes);
                            attributes =
                                tree.adjustForeignAttributes(attributes);
                        ...
                        modes.inForeignContent.processStartTag = function (
                            ...
                            if (
                                ...
                                attributes =
                                    tree.adjustSVGAttributes(attributes);
                            }
                            attributes =
                                tree.adjustForeignAttributes(attributes);
                            tree.insertForeignElement(
                        ...
                        modes.inTable.startTagInput = function (
                            ...
                            for (var key in attributes) {
                                if (
                                    attributes[key].nodeName.toLowerCase() ==
                                    "type"
                                ) {
                                    if (
                                        attributes[
                        ...
                        modes.inTableText.flushCharacters = function () {
                            var characters =
                                tree.pendingTableCharacters.join("");
                        ...
                        modes.inSelect.endTagOptgroup = function (name) {
                            ...
                            if (
                                tree.currentStackItem().localName == "optgroup"
                            ) {
                                tree.popElement();
                            } else {
                                tree.parseError(
                    ...
                    TreeBuilder.prototype.adoptionAgencyEndTag = function (
                        ...
                        while (outerLoopCounter++ < outerIterationLimit) {
                            formattingElement =
                                this.elementInActiveFormattingElements(name);
                    ...
                    TreeBuilder.prototype.insertIntoFosterParent = function (
                        ...
                        var tableElement =
                            this.openElements.item(tableIndex).node;
                        if (tableIndex === 0)
                    ...
                    TreeBuilder.prototype.removeElementFromActiveFormattingElements =
                        function (item) {
                            var index =
                                this.activeFormattingElements.indexOf(item);
                            if (index >= 0)
                                this.activeFormattingElements.splice(index, 1);
                        };

                    TreeBuilder.prototype.elementInActiveFormattingElements =
                        function (name) {
                    ...
                    TreeBuilder.prototype.clearActiveFormattingElements =
                        function () {
                            while (
                                !(
                                    this.activeFormattingElements.length ===
                    ...
                    TreeBuilder.prototype.processGenericRCDATAStartTag =
                        function (name, attributes) {
                    ...
                    TreeBuilder.prototype.processGenericRawTextStartTag =
                        function (name, attributes) {
                            this.insertElement(name, attributes);
                            this.tokenizer.setState(Tokenizer.RAWTEXT);
                            this.originalInsertionMode = this.insertionModeName;
                    ...
                    TreeBuilder.prototype.adjustMathMLAttributes = function (
                        ...
                        attributes.forEach(function (a) {
                            ...
                            if (constants.MATHMLAttributeMap[a.nodeName])
                                a.nodeName =
                                    constants.MATHMLAttributeMap[a.nodeName];
                        });
                        return attributes;
                    };
            ...
            9: [
                function (_dereq_, module, exports) {
                    var SAXTreeBuilder =
                        _dereq_("./SAXTreeBuilder").SAXTreeBuilder;
                    var Tokenizer = _dereq_("../Tokenizer").Tokenizer;
                ...
                function (_dereq_, module, exports) {
                    ...
                    SAXTreeBuilder.prototype.insertText = function (data) {
                        if (
                            ...
                            var tableIndex =
                                this.openElements.findIndex("table");
                    ...
                    SAXTreeBuilder.prototype.attachNodeToFosterParent =
                        function (child, table, stackParent) {
                            var parent = table.parentNode;
                            if (parent)
                                parent.insertBetween(
                                    child,
