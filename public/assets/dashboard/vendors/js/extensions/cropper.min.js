...
!(function (t, i) {
    ...
    var i = "undefined" != typeof window ? window : {},
        ...
        m = "cropmove",
        g = "cropstart",
        u = i.PointerEvent ? "pointerdown" : "touchstart mousedown",
    ...
    function z(t) {
        var i =
            arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : 1e11;
        return X.test(t) ? Math.round(t * i) / i : t;
    }
    var O = i.location,
        E = /^(https?:)\/\/([^:/?#]+):?(\d*)/i;
    function N(t) {
        var i = t.match(E);
        return (
            i && (i[1] !== O.protocol || i[2] !== O.hostname || i[3] !== O.port)
        );
    }
    function R(t) {
    ...
    function L(t) {
        var i = t.rotate,
            ...
            h = [];
        return (
            D(n) && 0 !== n && h.push("translateX(" + n + "px)"),
            D(o) && 0 !== o && h.push("translateY(" + o + "px)"),
            D(i) && 0 !== i && h.push("rotate(" + i + "deg)"),
            D(e) && 1 !== e && h.push("scaleX(" + e + ")"),
            D(a) && 1 !== a && h.push("scaleY(" + a + ")"),
            h.length ? h.join(" ") : "none"
        );
    }
    var P = i.navigator,
        I = P && /(Macintosh|iPhone|iPod|iPad).*AppleWebKit/i.test(P.userAgent);
    function U(i, e) {
        var a = i.pageX,
            n = i.pageY,
            o = { endX: a, endY: n };
    ...
    var A = Number.isFinite || i.isFinite;
    function F(t) {
        var i = t.aspectRatio,
            e = t.height,
            a = t.width,
        ...
        if (n) {
            ...
            if (
                ...
                (function (t, i, e) {
                    var a = "",
                        n = void 0;
                    for (e += i, n = i; n < e; n += 1) a += j(t.getUint8(n));
                    return a;
                })(i, n + 4, 4)
            ) {
                var d = i.getUint16(r);
                if (
                    ((a = 18761 === d) || 19789 === d) &&
                    42 === i.getUint16(r + 2, a)
                ) {
                    var l = i.getUint32(r + 4, a);
                    l >= 8 && (o = r + l);
                }
            }
        }
        if (o) {
            var c = i.getUint16(o, a),
                p = void 0,
                m = void 0;
            for (m = 0; m < c; m += 1)
    ...
    var Q = {
                        ...
                        (h > 1
                            ? ((d = Math.max(d, a.width)),
                              ...
                              3 === h &&
                                  (l * s > d ? (d = l * s) : (l = d / s)))
                            : d
                            ? (d = Math.max(d, r ? o.width : 0))
                            : l
                            ? (l = Math.max(l, r ? o.height : 0))
                            : r &&
                              ((d = o.width),
                              (l = o.height) * s > d
                                  ? (d = l * s)
                                  : (l = d / s)));
                    var c = F({ aspectRatio: s, width: d, height: l });
                    (d = c.width),
                        (l = c.height),
                        (n.minWidth = d),
                        (n.minHeight = l),
            ...
            renderCanvas: function (t, i) {
                ...
                (e.width > e.maxWidth || e.width < e.minWidth) &&
                    ...
                    this.$canvas.css({
                        width: e.width,
                        height: e.height,
                        transform: L({ translateX: e.left, translateY: e.top }),
                    }),
                    this.renderImage(t),
            ...
            renderImage: function (i) {
                ...
                t.extend(a, {
                    ...
                    this.$clone.css({
                        ...
                        transform: L(
                            t.extend(
                                { translateX: a.left, translateY: a.top },
                                a
                            )
                        ),
                    }),
            ...
            limitCropBox: function (t, i) {
                ...
                if (t) {
                    var r = Number(e.minCropBoxWidth) || 0,
                        ...
                        c = Math.min(a.height, h ? n.height : a.height);
                    (r = Math.min(r, a.width)),
                        ...
                        s &&
                            (r && d
                                ...
                                : d && (r = d * s),
                            c * s > l ? (c = l / s) : (l = c * s)),
                        (o.minWidth = Math.min(r, l)),
                        (o.minHeight = Math.min(d, c)),
                        (o.maxWidth = l),
                        (o.maxHeight = c);
                }
                i &&
            ...
            output: function () {
                this.preview(),
                    this.completed && this.trigger(c, this.getData());
            },
        },
        K = {
            ...
            preview: function () {
                ...
                this.cropped &&
                    ...
                    (this.$clone2.css({
                        ...
                        height: s,
                        transform: L(
                            t.extend({ translateX: -r, translateY: -d }, i)
                        ),
                    }),
        ...
        Z = {
            bind: function () {
                var i = this.$element,
                    e = this.options,
                    a = this.$cropper;
                t.isFunction(e.cropstart) && i.on(g, e.cropstart),
                    t.isFunction(e.cropmove) && i.on(m, e.cropmove),
                    t.isFunction(e.cropend) && i.on(p, e.cropend),
                    t.isFunction(e.crop) && i.on(c, e.crop),
                    t.isFunction(e.zoom) && i.on("zoom", e.zoom),
                    a.on(u, H(this.cropStart, this)),
                    e.zoomable && e.zoomOnWheel && a.on(w, H(this.wheel, this)),
                    e.toggleDragModeOnDblclick &&
                        a.on("dblclick", H(this.dblclick, this)),
                    t(this.element.ownerDocument)
                        .on(f, (this.onCropMove = H(this.cropMove, this)))
                        .on(v, (this.onCropEnd = H(this.cropEnd, this))),
                    e.responsive &&
                        t(window).on(
                            "resize",
                            (this.onResize = H(this.resize, this))
                        );
            },
            unbind: function () {
                var i = this.$element,
                    e = this.options,
                    a = this.$cropper;
                t.isFunction(e.cropstart) && i.off(g, e.cropstart),
                    t.isFunction(e.cropmove) && i.off(m, e.cropmove),
                    t.isFunction(e.cropend) && i.off(p, e.cropend),
                    t.isFunction(e.crop) && i.off(c, e.crop),
                    t.isFunction(e.zoom) && i.off("zoom", e.zoom),
                    a.off(u, this.cropStart),
                    e.zoomable && e.zoomOnWheel && a.off(w, this.wheel),
                    e.toggleDragModeOnDblclick &&
                        a.off("dblclick", this.dblclick),
                    t(this.element.ownerDocument)
                        .off(f, this.onCropMove)
                        .off(v, this.onCropEnd),
        ...
        V = {
            ...
            dblclick: function () {
                this.disabled ||
                    ...
                    this.setDragMode(
                        this.$dragBox.hasClass(a) ? "move" : "crop"
                    );
            },
            wheel: function (t) {
                var i = this,
            ...
            cropStart: function (i) {
                if (!this.disabled) {
                    var e = this.options,
                        ...
                        o = void 0;
                    n && n.changedTouches
                        ? t.each(n.changedTouches, function (t, i) {
                              a[i.identifier] = U(i);
                          })
                        : (a[(n && n.pointerId) || 0] = U(n || i)),
                        (o =
                            Y(a).length > 1 && e.zoomable && e.zoomOnTouch
                                ? "zoom"
                                : t(i.target).data(d)),
                        x.test(o) &&
                            (this.trigger(g, {
                ...
                if (!this.disabled && e) {
                    ...
                    i.preventDefault(),
                        this.trigger(m, {
                            ...
                            (n && n.changedTouches
                                ? t.each(n.changedTouches, function (i, e) {
                                      t.extend(a[e.identifier], U(e, !0));
                                  })
                                : t.extend(
                                      a[(n && n.pointerId) || 0],
                                      U(n || i, !0)
                ...
                if (!this.disabled) {
                    ...
                    n && n.changedTouches
                        ...
                        e &&
                            ...
                            this.trigger(p, { originalEvent: n, action: e }));
                }
            },
        },
        G = {
            change: function (i) {
                var e = this.options,
                    ...
                    b = !0,
                    y = void 0;
                !d && i.shiftKey && (d = p && m ? p / m : 1),
                    this.limited &&
                        ((f = s.minLeft),
                        (v = s.minTop),
                        (w = f + Math.min(n.width, h.width, h.left + h.width)),
                        (x =
                            v +
                            Math.min(n.height, h.height, h.top + h.height)));
                var C,
                    M,
                    $,
                    B = a[Y(a)[0]],
                    k = { x: B.endX - B.startX, y: B.endY - B.startY },
                    W = function (t) {
                        switch (t) {
                            case "e":
                                g + k.x > w && (k.x = w - g);
        ...
        J = {
            crop: function () {
                this.ready &&
                    ...
                    (this.cropped ||
                        ((this.cropped = !0),
                        this.limitCropBox(!0, !0),
                        this.options.modal && this.$dragBox.addClass(s),
                        this.$cropBox.removeClass(o)),
            ...
            enable: function () {
                this.ready &&
                    ((this.disabled = !1), this.$cropper.removeClass(n));
            },
            disable: function () {
                this.ready && ((this.disabled = !0), this.$cropper.addClass(n));
            },
            destroy: function () {
                var t = this.$element;
                this.loaded
                    ? (this.isImg &&
                          this.replaced &&
                          t.attr("src", this.originalUrl),
                      this.unbuild(),
                      t.removeClass(o))
                    : this.isImg
                    ? t.off("load", this.start)
            ...
            move: function (t, i) {
                var e = this.canvas,
                    a = e.left,
                    n = e.top;
                this.moveTo(T(t) ? t : a + Number(t), T(i) ? i : n + Number(i));
            },
            moveTo: function (t, i) {
                var e = this.canvas,
                    a = !1;
            ...
            zoomTo: function (i, e) {
                ...
                if (
                    ...
                    if (f) {
                        ...
                        (d.left -= (g - l) * ((w.pageX - v.left - d.left) / l)),
                            (d.top -=
                                (u - c) * ((w.pageY - v.top - d.top) / c));
                    } else (d.left -= (g - l) / 2), (d.top -= (u - c) / 2);
                    (d.width = g), (d.height = u), this.renderCanvas(!0);
                }
            },
            rotate: function (t) {
            ...
            rotateTo: function (t) {
                D((t = Number(t))) &&
                    ...
                    ((this.image.rotate = t % 360), this.renderCanvas(!0, !0));
            },
            scaleX: function (t) {
                var i = this.image.scaleY;
                this.scale(t, D(i) ? i : 1);
            },
            scaleY: function (t) {
                var i = this.image.scaleX;
                this.scale(D(i) ? i : 1, t);
            },
            scale: function (t) {
                var i =
                        arguments.length > 1 && void 0 !== arguments[1]
            ...
            getData: function () {
                ...
                return (
                    e.rotatable && (h.rotate = a.rotate || 0),
                    e.scalable &&
                        ((h.scaleX = a.scaleX || 1),
                        (h.scaleY = a.scaleY || 1)),
                    h
            ...
            setData: function (i) {
                ...
                if (
                    ...
                    e.rotatable &&
                        D(i.rotate) &&
                        i.rotate !== a.rotate &&
                        ((a.rotate = i.rotate), (h = !0)),
                        e.scalable &&
                            (D(i.scaleX) &&
                                i.scaleX !== a.scaleX &&
                                ((a.scaleX = i.scaleX), (h = !0)),
                            D(i.scaleY) &&
                                i.scaleY !== a.scaleY &&
                                ((a.scaleY = i.scaleY), (h = !0))),
                        h && this.renderCanvas(!0, !0);
                    var s = a.width / a.naturalWidth;
                    D(i.x) && (o.left = i.x * s + n.left),
                        D(i.y) && (o.top = i.y * s + n.top),
                        D(i.width) && (o.width = i.width * s),
                        D(i.height) && (o.height = i.height * s),
            ...
            setCanvasData: function (i) {
                ...
                t.isFunction(i) && (i = i.call(this.$element)),
                    this.ready &&
                        !this.disabled &&
                        t.isPlainObject(i) &&
                        (D(i.left) && (e.left = i.left),
                        D(i.top) && (e.top = i.top),
                        D(i.width)
                            ? ((e.width = i.width), (e.height = i.width / a))
                            : D(i.height) &&
                              ((e.height = i.height), (e.width = i.height * a)),
                        this.renderCanvas(!0));
            },
            ...
            setCropBoxData: function (i) {
                ...
                t.isFunction(i) && (i = i.call(this.$element)),
                    this.ready &&
                        ...
                        D(i.height) &&
                            i.height !== e.height &&
                            ((o = !0), (e.height = i.height)),
                        a &&
                            (n
                                ? (e.height = e.width / a)
                                : o && (e.width = e.height * a)),
                        this.renderCropBox());
            },
            getCroppedCanvas: function () {
                ...
                var e,
                    ...
                    U =
                        ...
                        (H = o.minHeight),
                        (Y = void 0 === H ? 0 : H),
                        (X = F({ aspectRatio: g, width: $, height: W })),
                        (O = F({ aspectRatio: g, width: T, height: Y })),
                        (E = Math.min(X.width, Math.max(O.width, u))),
                        (N = Math.min(X.height, Math.max(O.height, f))),
                ...
                var A = this.getData(),
                    ...
                    J = G.width,
                    _ = G.height;
                (J = Math.min(Z.width, Math.max(V.width, J))),
                    (_ = Math.min(Z.height, Math.max(V.height, _)));
                var tt = document.createElement("canvas"),
                    it = tt.getContext("2d");
                (tt.width = z(J)),
                    (tt.height = z(_)),
                    (it.fillStyle = i.fillColor || "transparent"),
                    it.fillRect(0, 0, J, _);
                var et = i.imageSmoothingEnabled,
                    at = void 0 === et || et,
                    nt = i.imageSmoothingQuality;
                (it.imageSmoothingEnabled = at),
                    nt && (it.imageSmoothingQuality = nt);
                var ot = U.width,
                    ht = U.height,
                    st = j,
                    rt = S,
                ...
                st <= -q || st > ot
                    ? ((st = 0), (dt = 0), (ct = 0), (mt = 0))
                    : st <= 0
                    ? ((ct = -st), (st = 0), (mt = dt = Math.min(ot, q + st)))
                    : st <= ot && ((ct = 0), (mt = dt = Math.min(q, ot - st))),
                    dt <= 0 || rt <= -Q || rt > ht
                        ? ((rt = 0), (lt = 0), (pt = 0), (gt = 0))
                        : rt <= 0
                        ? ((pt = -rt),
                          (rt = 0),
                          (gt = lt = Math.min(ht, Q + rt)))
                        : rt <= ht &&
                          ((pt = 0), (gt = lt = Math.min(Q, ht - rt)));
                var ut = [st, rt, dt, lt];
                if (mt > 0 && gt > 0) {
                    var ft = J / q;
                    ut.push(ct * ft, pt * ft, mt * ft, gt * ft);
                }
                return (
                    it.drawImage.apply(
                        it,
            ...
            function i(e) {
                var a =
                    arguments.length > 1 && void 0 !== arguments[1]
                        ? arguments[1]
                        : {};
                if (($(this, i), !e || !C.test(e.tagName)))
                    throw new Error(
                        "The first argument is required and must be an <img> or <canvas> element."
                    );
                (this.element = e),
                    (this.$element = t(e)),
                    (this.options = t.extend({}, M, t.isPlainObject(a) && a)),
                    (this.completed = !1),
                    (this.cropped = !1),
                    (this.disabled = !1),
                    (this.isImg = !1),
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function (i) {
                                ...
                                o.rotatable && (h.rotate = r),
                                    o.scalable &&
                                        ((h.scaleX = d), (h.scaleY = l)),
                                    this.clone();
                            },
                        },
                        {
                            ...
                            value: function () {
                                ...
                                if (this.loaded) {
                                    ...
                                    (this.$container = a.parent()),
                                        ...
                                        (this.$face = g),
                                        a.addClass(o).after(p),
                                        this.isImg || l.removeClass(h),
                                        this.initPreview(),
                                        this.bind(),
                                        (n.aspectRatio =
                                            Math.max(0, n.aspectRatio) || NaN),
                                        (n.viewMode =
                                            Math.max(
                                                0,
                                                Math.min(
                                                    3,
                                                    Math.round(n.viewMode)
                                                )
                                            ) || 0),
                                        (this.cropped = n.autoCrop),
                                        n.autoCrop
                                            ? n.modal &&
                                              this.$dragBox.addClass(s)
                                            : m.addClass(o),
                                        ...
                                        n.center ||
                                            m
                                                ...
                                                .addClass(o),
                                        n.cropBoxMovable &&
                                            g.addClass(r).data(d, "all"),
                                        n.highlight ||
                                            g.addClass("cropper-invisible"),
                                        n.background && p.addClass(e + "-bg"),
                                        n.cropBoxResizable ||
                                            m
                                                .find(
                                                    "." +
                                        ...
                                        (this.completing = setTimeout(
                                            function () {
                                                t.isFunction(n.ready) &&
                                                    a.one("ready", n.ready),
                                                    i.trigger("ready"),
                                                    i.trigger(c, i.getData()),
                                                    (i.completed = !0);
                                            },
                                            0
                                        ));
                    ...
                    [
                        {
                            key: "setDefaults",
                            value: function (i) {
                                t.extend(M, t.isPlainObject(i) && i);
                            },
                        },
                    ]
                ),
    ...
    if ((t.extend && t.extend(_.prototype, Q, K, Z, V, G, J), t.fn)) {
        var tt = t.fn.cropper;
            ...
            return (
                this.each(function (a, o) {
                    ...
                    if (!r) {
                        ...
                        (r = new _(o, d)), s.data(e, r);
                    }
                    if ("string" == typeof i) {
                        var l = r[i];
                        t.isFunction(l) && (h = l.apply(r, n));
                    }
                }),
                T(h) ? this : h
            );
        }),
            (t.fn.cropper.Constructor = _),
            (t.fn.cropper.setDefaults = _.setDefaults),
            (t.fn.cropper.noConflict = function () {
                return (t.fn.cropper = tt), this;
            });
    }
});
