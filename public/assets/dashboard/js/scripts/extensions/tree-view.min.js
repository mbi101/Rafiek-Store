...
$(document).ready(function () {
    var defaultData = [
        ...
        json =
            '[{"text": "Parent 1","nodes": [{"text": "Child 1","nodes": [{"text": "Grandchild 1"},{"text": "Grandchild 2"}]},{"text": "Child 2"}]},{"text": "Parent 2"},{"text": "Parent 3"},{"text": "Parent 4"},{"text": "Parent 5"}]';
    $("#default-treeview").treeview({ data: defaultData }),
        $("#collapsed-treeview").treeview({ levels: 1, data: defaultData }),
        $("#expanded-treeview").treeview({ levels: 99, data: defaultData }),
    ...
    var $searchableTree =
            ($("#data-treeview").treeview({ data: json }),
        ...
        search = function (e) {
            var pattern = $("#input-search").val(),
                ...
                results = $searchableTree.treeview("search", [
                    pattern,
                    options,
                ]),
