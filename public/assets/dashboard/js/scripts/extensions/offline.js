...
$(document).ready(function () {
    $(".browser iframe").each(function () {
        ...
        doc.write(
            "" +
                '<link rel="stylesheet" href="../../../app-assets/vendors/css/extensions/offline/themes/offline-theme-' +
                themeName +
                '.css" />' +
                '<link rel="stylesheet" href="../../../app-assets/vendors/css/extensions/offline/themes/offline-language-english' +
                (themeName.match(/\-indicator$/) ? "-indicator" : "") +
                '.css" />' +
