        ...
        .init(
            {
                ...
                backend: {
                    loadPath:
                        "../../../app-assets/data/locales/{{lng}}/{{ns}}.json",
                },
                returnObjects: true,
            },
            function (err, t) {
                ...
                if (i18next.language == "en") {
                    ...
                    var drop_lng = $('.lng-dropdown a[data-lng="en"]').addClass(
                        "active"
                    );
                ...
                if (i18next.language == "es") {
                    ...
                    $(".lng-dropdown a").removeClass("active");
                    var drop_lng = $('.lng-dropdown a[data-lng="es"]').addClass(
                        "active"
                    );
                    $("#dropdown-active-item").html(drop_lng.html());
                }
                ...
                if (i18next.language == "pt") {
                    ...
                    $(".lng-dropdown a").removeClass("active");
                    var drop_lng = $('.lng-dropdown a[data-lng="pt"]').addClass(
                        "active"
                    );
                    $("#dropdown-active-item").html(drop_lng.html());
                }
                ...
                if (i18next.language == "fr") {
                    ...
                    $(".lng-dropdown a").removeClass("active");
                    var drop_lng = $('.lng-dropdown a[data-lng="fr"]').addClass(
                        "active"
                    );
                    $("#dropdown-active-item").html(drop_lng.html());
                }
