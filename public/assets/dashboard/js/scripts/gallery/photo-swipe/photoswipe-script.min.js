                    ...
                    (figureEl = thumbElements[i]),
                        1 === figureEl.nodeType &&
                            ...
                            linkEl.children.length > 0 &&
                                (item.msrc =
                                    linkEl.children[0].getAttribute("src")),
                            (item.el = figureEl),
                            items.push(item));
                return items;
            },
            ...
            onThumbnailsClick = function (e) {
                ...
                var eTarget = e.target || e.srcElement,
                    clickedListItem = closest(eTarget, function (el) {
                        return (
                            el.tagName && "FIGURE" === el.tagName.toUpperCase()
                        );
                    });
                if (clickedListItem) {
                    for (
                ...
                if (
                    ...
                    (options = {
                        ...
                        getThumbBoundsFn: function (index) {
                            var thumbnail =
                                    items[index].el.getElementsByTagName(
                                        "img"
                                    )[0],
                                pageYScroll =
                                    window.pageYOffset ||
