...
!(function (window, document, $) {
    ...
    var body = $("body"),
        ...
        semiLight = !1,
        semiDark = !1;
    header_navbar.hasClass("navbar-semi-light") && (semiLight = !0),
        header_navbar.hasClass("navbar-semi-dark") && (semiDark = !0),
        "horizontal-menu" == menu_type &&
            ((horz_layout = !0),
        ...
        ("vertical-compact-menu" !== menu_type &&
            "vertical-content-menu" !== menu_type &&
            "vertical-overlay-menu" !== menu_type) ||
            ...
            $(".color-options .nav-semi-dark")
                ...
                .attr("style", "display: none !important")),
        "vertical-overlay-menu" === menu_type &&
            ($("#collapsed-sidebar").prop("checked", !0),
            $("#static-layout")
                .parent(".custom-checkbox")
                .attr("style", "display: none !important"),
            $("#static-navigation")
            ...
            $("#boxed-layout").prop("checked") === !0 &&
                ...
                $(this).prop("checked") === !0
                    ? (body.hasClass("fixed-navbar") ||
                      ...
                      header_navbar.hasClass("fixed-top") ||
                          horz_layout !== !1 ||
                          header_navbar.addClass("fixed-top"),
                      footer.hasClass("navbar-fixed-bottom") ||
        ...
        $("#boxed-layout").on("click", function () {
            $("#fixed-layout").prop("checked") === !0 &&
                $("#fixed-layout").trigger("click"),
                $(this).prop("checked") === !0
                    ? (body.hasClass("container boxed-layout") ||
                          body.addClass("container boxed-layout"),
                      header_navbar.hasClass("container boxed-layout") ||
        ...
        $("#static-layout").on("click", function () {
            $(this).prop("checked") === !0
                ? (header_navbar.hasClass("navbar-static-top") ||
                      header_navbar.addClass("navbar-static-top"),
                  menu.hasClass("menu-static") || menu.addClass("menu-static"),
                  footer.hasClass("footer-static") ||
        ...
        "vertical-overlay-menu" === menu_type &&
            $("#brand-center").prop("checked", !0),
        $("#brand-center").on("click", function () {
            header_navbar.hasClass("navbar-brand-center")
                ? (1 == semiLight &&
                      (header_navbar.removeClass(
                          "navbar-dark navbar-brand-center"
                      ),
                      changeLogo("dark"),
        ...
        $("#native-scroll").on("click", function () {
            $("#static-navigation").prop("checked") === !0 &&
                (menu.removeClass("menu-static").addClass("menu-fixed"),
                $("#static-navigation").attr("checked", !1)),
                menu.hasClass("menu-native-scroll")
        ...
        $("#right-side-icons").on("click", function () {
            menu.hasClass("menu-icon-right")
                ? menu.removeClass("menu-icon-right")
                : menu.addClass("menu-icon-right"),
                horz_layout === !0 &&
                    (horz_header_navbar.hasClass("navbar-icon-right")
    ...
    el.attr("class").match(/\bbg-\S+/g) &&
        ...
        $(".nav-semi-light").on("click", function () {
            chkBgClass(el),
                ...
                $("input[name=nav-slight-clr].default").prop("checked", !0),
                (semiLight = !0),
                (semiDark = !1);
        }),
        $("input[name='nav-slight-clr']").change(function () {
            1 == semiDark &&
                el
                    .removeClass("navbar-semi-dark")
                    .addClass("navbar-semi-light"),
        ...
        $(".nav-semi-dark").on("click", function () {
            chkBgClass(el),
                ...
                $("input[name=nav-sdark-clr].default").prop("checked", !0),
                (semiLight = !1),
                (semiDark = !0);
        }),
        $("input[name='nav-sdark-clr']").change(function () {
            1 == semiLight &&
                el
                    .removeClass("navbar-semi-light")
                    .addClass("navbar-semi-dark");
        ...
        $(".nav-dark").on("click", function () {
            chkBgClass(el),
                ...
                $("input[name=nav-dark-clr].default").prop("checked", !0);
        }),
        ...
        $(".nav-light").on("click", function () {
            chkBgClass(el),
                ...
                $("input[name=nav-light-clr].default").prop("checked", !0);
        }),
