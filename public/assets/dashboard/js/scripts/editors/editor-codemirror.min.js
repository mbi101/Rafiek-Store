...
!(function (window, document, $) {
    ...
    function selectTheme() {
        ...
        editor1.setOption("theme", theme), (location.hash = "#" + theme);
    }
    ...
    $("#select").change(function () {
        ...
        stylesheet.attr(
            "href",
            "../../../app-assets/vendors/css/editors/theme/" +
    ...
    choice && ((input.value = choice), editor1.setOption("theme", choice)),
        CodeMirror.on(window, "hashchange", function () {
            var theme = location.hash.slice(1);
            theme && ((input.value = theme), selectTheme());
        }),
        (code = document.getElementById("codemirror-loadmode")),
        (CodeMirror.modeURL =
            "../../../app-assets/vendors/js/editors/codemirror/mode/*/*.js");
    var editorMode = CodeMirror.fromTextArea(code, { lineNumbers: !0 }),
    ...
    CodeMirror.on(modeInput, "keypress", function (e) {
        ...
        $("#change").on("click", function () {
            ...
            if ((m = /.+\.([^.]+)$/.exec(val))) {
                ...
                info && ((mode = info.mode), (spec = info.mime));
            } else if (/\//.test(val)) {
                var info = CodeMirror.findModeByMIME(val);
                info && ((mode = info.mode), (spec = val));
            } else mode = spec = val;
            mode
    ...
    var code_html = document.getElementById("codemirror-html"),
        code_markdown = document.getElementById("codemirror-markdown");
    ...
    var delay,
        editor = new CodeMirror.fromTextArea(
            document.getElementById("codemirror-preview"),
            { mode: "text/html" }
        );
    ...
    value = "";
    for (var i = 1; i <= 9; i++) {
        rulers.push({ color: colors[i], column: 10 * i, lineStyle: "dashed" });
