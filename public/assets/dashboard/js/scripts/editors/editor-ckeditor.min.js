...
!(function (window, document, $) {
    ...
    CKEDITOR.on("instanceReady", function (ev) {
        (editor = ev.editor_readonly),
            ...
            editor_readonly.on("readOnly", function () {
                (document.getElementById("readOnlyOn").style.display = this
                    .readOnly
                    ? "none"
                    : ""),
                    (document.getElementById("readOnlyOff").style.display = this
                        .readOnly
                        ? ""
                        : "none");
            });
    ...
    introduction.setAttribute("contenteditable", !0),
