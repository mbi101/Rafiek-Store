...
!(function (window, document, $) {
    ...
    $(".disable-toggle").on("click", function () {
        ...
        $(".spectrum-disabled").spectrum({ disabled: !0 }),
        ...
        $(".spectrum-clear").spectrum({ allowEmpty: !0 }),
        $(".spectrum-initial-color").spectrum({ showInitial: !0 }),
        $(".spectrum-with-input").spectrum({ showInitial: !0, showInput: !0 }),
        ...
        $(".spectrum-transparancy").spectrum({ showAlpha: !0 }),
