...
!(function (window, document, $) {
    ...
    $(".pickadate").pickadate(),
        ...
        $(".pickadate-select-year").pickadate({ selectYears: 8 }),
        $(".pickadate-firstday").pickadate({ firstDay: 1 }),
        ...
        $(".pickadate-disable-weekday").pickadate({ disable: [3] }),
    ...
    var from_$input = $("#picker_from").pickadate(),
        ...
        to_$input = $("#picker_to").pickadate(),
        to_picker = to_$input.pickadate("picker");
    from_picker.get("value") && to_picker.set("min", from_picker.get("select")),
        to_picker.get("value") &&
            from_picker.set("max", to_picker.get("select")),
        from_picker.on("set", function (event) {
            event.select
                ? to_picker.set("min", from_picker.get("select"))
                : "clear" in event && to_picker.set("min", !1);
        }),
        to_picker.on("set", function (event) {
            event.select
                ? from_picker.set("max", to_picker.get("select"))
                : "clear" in event && from_picker.set("max", !1);
        }),
        $(".pickatime").pickatime(),
        $(".pickatime-button").pickatime({ clear: "" }),
        ...
        $(".pickatime-limits").pickatime({ min: -5, max: !0 }),
        ...
        $(".autoapply").daterangepicker({ autoApply: !0 }),
        $(".linkedCalendars").daterangepicker({ linkedCalendars: !1 }),
        $(".dateLimit").daterangepicker({ dateLimit: { days: 7 } }),
        $(".showdropdowns").daterangepicker({ showDropdowns: !0 }),
        $(".showweeknumbers").daterangepicker({ showWeekNumbers: !0 }),
        ...
        $(".openRight").daterangepicker({ opens: "left" }),
        $(".drops").daterangepicker({ drops: "up" }),
