...
!(function (window, document, $) {
    ...
    function queryFunction(query) {
        ...
        if ("single-input-with-submenus" === selectivity.$el.attr("id")) {
            if (!selectivity.dropdown)
                return void query.callback({ more: !1, results: [] });
            var timezone = selectivity.dropdown.highlightedResult.id;
            results = citiesWithTimezone
                .filter(function (city) {
                    return (
                        transformText(city.id).indexOf(transformText(term)) >
        ...
        results.sort(function (a, b) {
            (a = transformText(a)), (b = transformText(b));
    ...
    var cities = $("#single-select-box")
            ...
            .get(),
        citiesByCountry = $("#multiple-select-box")
            .find("optgroup")
            .map(function () {
                return {
            ...
            .get(),
        citiesWithTimezone = $("#multiple-select-box")
            .find("option")
            .map(function () {
                return {
                    id: this.textContent,
            ...
            .get(),
        transformText = $.fn.selectivity.transformText;
    ...
    var submenu = { query: queryFunction, showSearchInput: !0 };
    $(".single-input-with-submenus").selectivity({
        ...
        $(".without-search-box").selectivity({ showSearchInputInDropdown: !1 }),
