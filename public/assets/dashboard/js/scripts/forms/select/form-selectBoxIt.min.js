...
!(function (window, document, $) {
    ...
    $(".selectBox").selectBoxIt(),
        ...
        $(".selectBox-hide-first").selectBoxIt({ showFirstOption: !1 }),
        $(".selectBox-right-icon").selectBoxIt({
            downArrowIcon: "ft-arrow-down ml-1",
        }),
        $(".selectBox-aggressive").selectBoxIt({ aggressiveChange: !0 }),
        $(".selectBox-native-mouse").selectBoxIt({ nativeMousedown: !0 }),
        ...
        $(".selectBox-hide-current").selectBoxIt({ hideCurrent: !0 }),
            ...
            populate: function () {
                ...
                return (
                    $.ajax({
                        ...
                        for (; ++x < data.length; ) arr.push(data[x].name);
