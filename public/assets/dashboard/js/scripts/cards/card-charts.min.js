...
!(function (window, document, $) {
    ...
    var ctx1 = document.getElementById("emp-satisfaction").getContext("2d"),
        white_gradient = ctx1.createLinearGradient(0, 0, 0, 400);
    ...
    var empSatOptions = {
        ...
        ctx2 =
            (new Chart(ctx1, empSatconfig),
            document.getElementById("line-stacked-area").getContext("2d")),
        userPageVisitOptions = {
            responsive: !0,
            maintainAspectRatio: !1,
            pointDotStrokeWidth: 4,
            legend: {
        ...
        ctx3 =
            (new Chart(ctx2, userPageVisitConfig),
            document.getElementById("earning-chart").getContext("2d")),
        earningOptions = {
            responsive: !0,
            maintainAspectRatio: !1,
            datasetStrokeWidth: 3,
        ...
        ctx4 = (new Chart(ctx3, earningConfig), $("#posts-visits")),
        PostsVisitsOptions = {
            responsive: !0,
            maintainAspectRatio: !1,
        ...
        ctx5 =
            (new Chart(ctx4, postsVisitsConfig),
            document.getElementById("global-sales").getContext("2d")),
        white_gradient2 = ctx1.createLinearGradient(0, 0, 0, 400);
    ...
    var gloablSalesOptions = {
        ...
        ctx6 = (new Chart(ctx5, globalSalesConfig), $("#revenue-comparision")),
        revenueComparisionOptions = {
            responsive: !0,
            maintainAspectRatio: !1,
            responsiveAnimationDuration: 500,
            hoverMode: "label",
        ...
        revenueComparisionConfig = {
            type: "horizontalBar",
            options: revenueComparisionOptions,
            data: revenueComparisionData,
        };
    new Chart(ctx6, revenueComparisionConfig);
    Morris.Area({
    ...
    var ctx7 = $("#advertisement-expense"),
        ...
        config = { type: "radar", options: chartOptions, data: chartData };
    new Chart(ctx7, config);
    new Chartist.Line(
        "#cost-revenue",
        {
