            ...
            lists: [
                    ...
                    items: [
                        {
                            ...
                            description:
                                "Phasellus vel elit volutpat, egestas urna a, pharetra nibh.",
                            dueDate: "2016-12-31",
                        },
                        {
                            title: "Menu open issue on top",
                            description:
                                "Proin varius libero at magna dignissim lacinia.",
                            dueDate: "2016-12-22",
                            done: !0,
                        },
                        {
                            ...
                            description:
                                "Curabitur tempor, quam vel pulvinar finibus.",
                            dueDate: "2016-12-29",
                        },
                        {
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            description:
                                "Leopards twilight whenever warm read wish squirrel rock.",
                            dueDate: "2016-02-04",
                            done: !0,
                        },
                    ],
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            description:
                                "Aliquam finibus tellus magna, eget viverra augue gravida eget.",
                            dueDate: "2016-12-05",
                        },
                        {
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { title: "Complete dashboard page design", done: !0 },
                        {
        ...
        (function () {
            ...
            $("#todo-lists-initialize-btn").on("click", function () {
                list = $("#todo-lists-demo-events")
                    .lobiList({
                        init: function () {
                            Lobibox.notify("default", { msg: "init" });
                        },
                        beforeDestroy: function () {
                            Lobibox.notify("default", { msg: "beforeDestroy" });
                        },
                        afterDestroy: function () {
                            Lobibox.notify("default", { msg: "afterDestroy" });
                        },
                        beforeListAdd: function () {
                            Lobibox.notify("default", { msg: "beforeListAdd" });
                        },
                        afterListAdd: function () {
                            Lobibox.notify("default", { msg: "afterListAdd" });
                        },
                        ...
                        beforeItemAdd: function () {
                            Lobibox.notify("default", { msg: "beforeItemAdd" });
                        },
                        afterItemAdd: function () {
                            Lobibox.notify("default", { msg: "afterItemAdd" });
                        },
