...
$(window).on("load", function () {
    $("#recent-buyers, #new-orders").perfectScrollbar({ wheelPropagation: !0 }),
        ...
        !(function () {
            var scoreChart = function scoreChart(id, labelList, series1List) {
                    ...
                    scoreChart
                        .on("created", function (data) {
                            ...
                            return (
                                ...
                                filter.elem("feOffset", { dx: "0", dy: "32" }),
                                filter.elem("feBlend", {
                                    in: "SourceGraphic",
                                    mode: "multiply",
                                }),
                ...
                createChart = function (button) {
                    var btn =
                            button ||
                            $("#ecommerceChartView .chart-action").find(
                                ".active"
                            ),
                        chartId = btn.attr("href");
                    switch (chartId) {
                        case "#scoreLineToDay":
                            scoreChart(
                                "scoreLineToDay",
