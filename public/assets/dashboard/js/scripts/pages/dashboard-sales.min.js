...
$(window).on("load", function () {
    ...
    new Chart(ctx2, {
        ...
        options: {
            ...
            tooltips: {
                displayColors: !1,
                callbacks: { label: function (e, d) {}, title: function () {} },
            },
            legend: { display: !1 },
            scales: {
                xAxes: [{ gridLines: { display: !1 } }],
    ...
    var draw = Chart.controllers.doughnut.prototype.draw,
        customDoughnut = Chart.controllers.doughnut.extend({
            draw: function () {
                draw.apply(this, arguments);
                var ctx = this.chart.chart.ctx,
                    _fill = ctx.fill,
    ...
    var draw = Chart.controllers.doughnut.prototype.draw,
        customDealDoughnut = Chart.controllers.doughnut.extend({
            draw: function () {
                draw.apply(this, arguments);
                var ctx = this.chart.chart.ctx,
                    _fill = ctx.fill,
