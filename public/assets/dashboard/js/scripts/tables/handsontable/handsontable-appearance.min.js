...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function negativeValueRenderer(
        ...
        Handsontable.renderers.TextRenderer.apply(this, arguments),
            parseInt(value, 10) < 0 && (td.className = "make-me-red"),
            value && "" !== value
                ? ("Nissan" === value && (td.style.fontStyle = "italic"),
                  (td.style.background = ""))
    ...
    Handsontable.renderers.registerRenderer(
        ...
        (hot1 = new Handsontable(container, {
            ...
            afterSelection: function (row, col, row2, col2) {
                ...
                meta.readOnly
                    ? this.updateSettings({ fillHandle: !1 })
                    : this.updateSettings({ fillHandle: !0 });
            },
            cells: function (row, col, prop) {
                var cellProperties = {};
                return (
                    (0 !== row &&
                        "readOnly" !== this.instance.getData()[row][col]) ||
                        (cellProperties.readOnly = !0),
                    0 === row
    ...
    var hot,
        container = document.getElementById("borders");
    ...
    (hot = Handsontable(container, {
        ...
        hot.selectCell(2, 2);
    var hotMobilesTablets,
        containerMobilesTablets = document.getElementById("mobilesTablets");
