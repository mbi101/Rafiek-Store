...
$(window).on("load", function () {
    ...
    for (
        var data1 = [
            ...
            data1_points = {
                ...
                yerr: { show: !0, color: "#DA4453", upperCap: "-" },
            },
            data2 = [
                [0.7, 3, 0.2, 0.4],
                [1.5, 2.2, 0.3, 0.4],
            ...
            data3_points = {
                radius: 0,
                errorbars: "y",
                yerr: { show: !0, upperCap: "-", lowerCap: "-", radius: 5 },
            },
            data4 = [
                [1.3, 1],
                [1.75, 2.5],
    ...
    var data = [
        ...
        {
            color: "#FF4558",
            bars: { show: !0, align: "center", barWidth: 0.25 },
            data: data4,
            label: "data4",
        },
    ...
    $.plot($("#error-bars"), data, {
        legend: { position: "sw", show: !0 },
        series: { lines: { show: !1 } },
        xaxis: { min: 0.6, max: 3.1 },
        yaxis: { min: 0, max: 3.5 },
        zoom: { interactive: !0 },
        pan: { interactive: !0 },
        grid: {
