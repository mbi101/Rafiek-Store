...
function drawGuage() {
    var net_data = google.visualization.arrayToDataTable([
        ...
        earn_data = google.visualization.arrayToDataTable([
            ["Label", "Value"],
            ["Gross", 80],
            ["Tax", 25],
            ["Net", 55],
        ]),
        options_network_guage = {
            fontSize: 12,
            redFrom: 90,
            redTo: 100,
            yellowFrom: 75,
        ...
        net_guage = new google.visualization.Gauge(
            document.getElementById("guage-network-chart")
        );
    net_guage.draw(net_data, options_network_guage);
    var earn_guage = new google.visualization.Gauge(
        document.getElementById("guage-earning-chart")
    );
