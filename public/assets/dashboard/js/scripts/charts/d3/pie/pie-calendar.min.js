...
$(window).on("load", function () {
    function displayPreviousMonth() {
        d3CalendarGlobals.decrementCounter(), renderDaysOfMonth();
    }
    function displayNextMonth() {
        d3CalendarGlobals.incrementCounter(), renderDaysOfMonth();
    }
    ...
    function drawGraphsForMonthlyData() {
        var data = getDataForMonth(),
            outerRadius = d3CalendarGlobals.cellWidth / 3,
            innerRadius = 0,
            pie = d3.layout.pie(),
            color = d3.scale
                .ordinal()
        ...
        var arcs = d3CalendarGlobals.chartsGroup
            ...
            .attr("transform", function (d) {
                ...
                return (
                    "translate(" +
                    (outerRadius +
                        5 * d3CalendarGlobals.gridXTranslation +
                        cellPositions[currentDataIndex][0]) +
                    ", " +
                    (outerRadius +
                        1.25 * d3CalendarGlobals.gridYTranslation +
    ...
    function renderCalendarGrid(month, year) {
        ...
        d3CalendarGlobals.calendar
            ...
            .attr("dx", d3CalendarGlobals.gridXTranslation + 5)
            .attr("dy", 30)
            .text(function (d) {
    ...
    var d3CalendarGlobals = (function () {
        ...
        var datesGroup,
            calendarWidth = (d3.select("#pie-calendar"), 1380),
            calendarHeight = 820,
            gridXTranslation = 10,
            gridYTranslation = 40,
