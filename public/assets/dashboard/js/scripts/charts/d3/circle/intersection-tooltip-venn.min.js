...
$(window).on("load", function () {
    var sets = [
        ...
        chart = venn.VennDiagram().width(400).height(400).fontSize("14px"),
        div = d3.select("#intersection-tooltip-venn");
        ...
        div
            ...
            .on("mouseover", function (d, i) {
                ...
                selection
                    ...
                    .style("fill-opacity", 1 == d.sets.length ? 0.4 : 0.1)
            ...
            .on("mouseout", function (d, i) {
                ...
                selection
                    .select("path")
                    .style("stroke-width", 0)
                    .style("fill-opacity", 1 == d.sets.length ? 0.25 : 0)
                    .style("stroke-opacity", 0);
            });
});
