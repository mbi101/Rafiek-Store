...
$(window).on("load", function () {
    ...
    var y0 = d3.scale.ordinal().rangeRoundBands([height, 0], 0.2);
    ...
    d3.tsv(
        "../../../app-assets/data/d3/bar/stacked-to-multiples.tsv",
        function (error, data) {
    ...
    function resize() {
        ...
        // Axis
        // -------------------------
        x.rangeRoundBands([0, width], 0.1, 0);
