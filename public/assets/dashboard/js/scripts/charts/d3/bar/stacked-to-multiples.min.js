...
$(window).on("load", function () {
    ...
    var ele = d3.select("#stacked-to-multiples"),
        ...
        y0 = d3.scale.ordinal().rangeRoundBands([height, 0], 0.2),
        y1 = d3.scale.linear(),
        x = d3.scale.ordinal().rangeRoundBands([0, width], 0.1, 0),
        xAxis = d3.svg.axis().scale(x).orient("bottom").tickFormat(formatDate),
        ...
        function (error, data) {
            ...
            function transitionStacked() {
                ...
                g.selectAll(".d3-bar").attr("y", function (d) {
                    ...
                    g.select(".d3-group-label").attr("y", function (d) {
                        return y1(
                            d.values[0].value / 2 + d.values[0].valueOffset
                        );
                    });
            }
