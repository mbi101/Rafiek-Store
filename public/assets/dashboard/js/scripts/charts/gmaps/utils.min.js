    ...
    function loadResults(data) {
        ...
        if (data.venues.length > 0) {
            ...
            for (var i = 0; i < items.length; i++) {
                var item = items[i];
                if (
                    void 0 != item.location.lat &&
                    void 0 != item.location.lng
                ) {
                    var icon =
                    ...
                    markers_data.push({
                        ...
                        title: item.name,
                        icon: { size: new google.maps.Size(32, 32), url: icon },
                    });
                }
            }
        }
    ...
    $(document).on("submit", ".edit_marker", function (e) {
        ...
        $(document).on("click", ".pan-to-marker", function (e) {
            ...
            var lat,
                ...
                $lat = $(this).data("marker-lat"),
                $lng = $(this).data("marker-lng");
            if (void 0 != $index) {
    ...
    $(document).on("click", ".pan-to-marker", function (e) {
        ...
        json_map.on("marker_added", function (marker) {
            ...
            $("#results").append(
                ...
                index == json_map.markers.length - 1 && json_map.fitZoom();
        });
    var xhr = $.getJSON(
        "../../../app-assets/data/gmaps/foursquare.json?q[near]=Lima,%20PE&q[query]=Ceviche"
    );
    xhr.done(printResults), xhr.done(loadResults);
});
