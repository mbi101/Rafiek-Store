...
$(window).on("load", function () {
    $(".legend-plotted-cities").mapael({
        ...
        legend: {
            plot: {
                cssClass: "myLegend",
                labelAttrs: { fill: "#4a4a4a" },
                titleAttrs: { fill: "#4a4a4a" },
                marginBottom: 20,
                marginLeft: 30,
                hideElemsOnClick: { opacity: 0 },
