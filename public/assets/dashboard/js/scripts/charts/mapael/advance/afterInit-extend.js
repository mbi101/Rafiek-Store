    ...
    $(".afterInit-extend").mapael({
        map: {
            ...
            afterInit: function ($self, paper, areas, plots, options) {
                ...
                paper
                    .ellipse(100, 200, 100, 60)
                    .attr({ stroke: "#FF847C", fill: "#FF847C", opacity: 0.4 });
                paper
                    .ellipse(300, 150, 80, 100)
                    .attr({ stroke: "#99B898", fill: "#99B898", opacity: 0.4 });
                paper
                    .path(
                        "m 198.57144,240 c 0,0 23.57142,163.57143 143.57142,136.42857"
                    )
                    .attr({ stroke: "#99B898", "stroke-width": 4 });
            },
        },
        plots: {
            p1: {
