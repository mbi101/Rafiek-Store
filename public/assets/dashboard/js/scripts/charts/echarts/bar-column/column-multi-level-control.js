...
$(window).on("load", function () {
    ...
    require([
        ...
        // ------------------------------
        var myChart = ec.init(
            document.getElementById("column-multilevel-control")
        );
            ...
            series: [
                {
                    ...
                    type: "bar",
                    itemStyle: {
                        // Personalized style-level, longitudinal gradient fill
                        barBorderColor: "red",
                        barBorderWidth: 5,
                        color: (function () {
                            var zrColor = require("zrender/tool/color");
                            return zrColor.getLinearGradient(0, 400, 0, 300, [
                                [0, "green"],
                                [1, "yellow"],
                            ]);
                        })(),
                ...
                },
                {
                    ...
                    itemStyle: {
                        normal: {
                            // Series level personalization, horizontal gradient fill
                            borderRadius: 5,
                            color: (function () {
                                var zrColor = require("zrender/tool/color");
                                return zrColor.getLinearGradient(
