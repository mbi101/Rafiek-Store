    ...
    require([
            ...
            series: [
                {
                    ...
                    axisLine: {
                        ...
                        lineStyle: {
                            // Control Line Style property lineStyle
                            color: [
                                [0.2, "lightgreen"],
                                [0.4, "orange"],
                                [0.8, "skyblue"],
                    ...
                    axisLabel: {
                        ...
                        textStyle: {
                            // The remaining properties using the global default text style, see TEXTSTYLE
                            color: "#333",
                        },
                    },
                    splitLine: {
                        ...
                        lineStyle: {
                            // Property lineStyle (see lineStyle) control line style
                            color: "#eee",
                            width: 2,
                            type: "solid",
                        },
        ...
        $(function () {
            ...
            var timeTicket = setInterval(function () {
                anggaugeOptions.series[0].data[0].value =
