    ...
    require([
            ...
            series: [
                {
                    ...
                    splitLine: {
                        ...
                        lineStyle: {
                            // Attribute lineStyle (see lineStyle) control line style
                            color: "auto",
                        },
                    },
                    title: {
                        textStyle: {
                            // Remaining properties using the global default text style, see TEXTSTYLE
                            fontWeight: "bolder",
                            fontSize: 20,
                            fontStyle: "italic",
                        },
        ...
        $(function () {
            ...
            var timeTicket = setInterval(function () {
                multigaugeOptions.series[0].data[0].value =
                    (Math.random() * 100).toFixed(2) - 0;
                multigaugeOptions.series[1].data[0].value =
                    (Math.random() * 7).toFixed(2) - 0;
                multigaugeOptions.series[2].data[0].value =
                    (Math.random() * 2).toFixed(2) - 0;
                multigaugeOptions.series[3].data[0].value =
                    (Math.random() * 2).toFixed(2) - 0;
