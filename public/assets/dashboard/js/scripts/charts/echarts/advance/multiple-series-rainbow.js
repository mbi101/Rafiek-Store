...
$(window).on("load", function () {
    ...
    require([
        ...
        // ------------------------------
        var myChart = ec.init(
            document.getElementById("multiple-series-rainbow")
        );
            ...
            series: [
                {
                    ...
                    itemStyle: itemStyle,
                    data: [
                        4804.7, 1444.3, 1332.1, 908, 871.8, 1983.7, 1627.6,
                        499.2,
                    ],
                },
                {
                    ...
                    itemStyle: itemStyle,
                    data: [
                        5506.3, 1674.7, 1405, 1023.2, 969, 2149.7, 1851.7,
                        581.3,
                    ],
                },
                {
                    ...
                    itemStyle: itemStyle,
                    data: [
                        6040.9, 1823.4, 1484.3, 1116.1, 1063.7, 2455.5, 2033.5,
                        657.1,
                    ],
                },
                {
                    ...
                    itemStyle: itemStyle,
                    data: [
                        6311.9, 1902, 1745.1, 1215.1, 1118.3, 2736.9, 2294,
                        699.4,
                    ],
                },
            ],
