...
$(window).on("load", function () {
    ...
    require([
        ...
        // ------------------------------
        var myChart = ec.init(
            document.getElementById("line-multi-level-control")
        );
            ...
            series: [
                ...
                },
                {
                    ...
                    itemStyle: {
                        normal: {
                            color: "red",
                            lineStyle: {
                                // A line-level personalized style
                                width: 2,
                                type: "dashed",
                            },
                        },
                    ...
                    data: [
                        ...
                        334,
                        {
                            ...
                            symbolRotate: 10,
                            itemStyle: {
                                // Data class personalized style polyline
                                normal: {
                                    color: "yellowgreen",
                                },
                                emphasis: {
                ...
                },
                {
                    ...
                    itemStyle: {
                        normal: {
                            lineStyle: {
                                // A line-level personalized style, horizontal gradient strokes
                                width: 2,
                                color: "#F6BB42",
