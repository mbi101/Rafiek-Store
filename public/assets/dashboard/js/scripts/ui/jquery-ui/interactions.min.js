...
$(document).ready(function () {
    function updateCounterStatus($event_counter, new_count) {
        $event_counter.hasClass("ui-state-hover") ||
            $event_counter
    ...
    $start_counter.draggable({
        start: function () {
            counts[0]++, updateCounterStatus($start_counter, counts[0]);
        },
        ...
        $drag_counter.draggable({
            drag: function () {
                counts[1]++, updateCounterStatus($drag_counter, counts[1]);
            },
            containment: ".events-container",
            scroll: !1,
        }),
        $stop_counter.draggable({
            stop: function () {
                counts[2]++, updateCounterStatus($stop_counter, counts[2]);
            },
            containment: ".events-container",
            scroll: !1,
        }),
