...
$(document).ready(function () {
    ...
    $(".ac-default").autocomplete({ source: peopleTags });
    var names = ["Jörn Zaefferer", "Scott González", "John Resig"],
        accentMap = { á: "a", ö: "o" },
        normalize = function (term) {
            for (var ret = "", i = 0; i < term.length; i++)
    ...
    $(".ac-category").catcomplete({ delay: 0, source: data }),
        $.widget("custom.combobox", {
            ...
            _createShowAllButton: function () {
                ...
                $(
                    ...
                    .on("click", function () {
                        input.trigger("focus"),
                            wasOpen || input.autocomplete("search", "");
                    });
            },
                ...
                if (!ui.item) {
                    ...
                    this.element.children("option").each(function () {
                        if ($(this).text().toLowerCase() === valueLowerCase)
                            return (this.selected = valid = !0), !1;
                    }),
                        valid ||
                            (this.input
                                .val("")
    ...
    $(".ac-remote-caching").autocomplete({
        ...
        source: function (request, response) {
            ...
            return term in cache
                ? void response(cache[term])
                : void $.getJSON(
