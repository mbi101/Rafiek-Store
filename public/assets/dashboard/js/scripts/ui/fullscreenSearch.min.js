...
!(function () {
    var fullscreenSearch = $("#fullscreen-search"),
        ...
        isOpen = (isAnimating = !1),
        toggleSearch = function (event) {
            if ("focus" === event.type.toLowerCase() && isOpen) return !1;
            fullscreenSearch[0].getBoundingClientRect();
            isOpen
        ...
        document.addEventListener("keydown", function (e) {
            if (
                ($(e.target).is("input") ||
                    ...
                    $(e.target).hasClass("note-editable") ||
                    $(e.target).hasClass("cke_editable_inline")) &&
                "fullscreen-search-input" != e.target.className
            )
                return !1;
            var keyCode = e.keyCode || e.which;
            27 === keyCode && isOpen && toggleSearch(e),
