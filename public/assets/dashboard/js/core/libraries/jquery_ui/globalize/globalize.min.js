...
!(function (e, r) {
    ...
    (t = function (e) {
        ...
        (t.cultures["default"].calendar =
            t.cultures["default"].calendars.standard),
        ...
        (y = function (e, r) {
            ...
            if (1 === a) {
                if (((t = n[r]), !t))
                    throw "Invalid date format string '" + r + "'.";
                r = t;
        ...
        (M = function (e, r, t) {
            function n(e, r) {
                ...
                return r > 1 && n.length < r
                    ? ((t = v[r - 2] + n), t.substr(t.length - r, r))
                    : (t = n);
            }
            function a() {
                return h || g ? h : ((h = A.test(r)), (g = !0), h);
            }
            function s(e, r) {
                if (b) return b[r];
                switch (r) {
            ...
            for (!d && i && (b = i.fromGregorian(e)); ; ) {
                var I = S.lastIndex,
                    w = S.exec(r),
                    C = r.slice(I, w ? w.index : r.length);
                if (((x += m(C, u)), !w)) break;
                if (x % 2) u.push(w[0]);
                else {
                    var D = w[0],
            ...
            (e = function (e, r, t) {
                ...
                (i = o[0]),
                    ...
                    f > 0
                        ...
                        : 0 > f &&
                          ((f = -f),
                          (i = b(i, f + 1, !0)),
                          (c = i.slice(-f, i.length) + c),
                          (i = i.slice(0, -f))),
                    (c =
                        r > 0
                            ? t["."] + (c.length > r ? c.slice(0, r) : b(c, r))
                            : "");
                ...
                (v = function (r, t, n) {
                    ...
                    for (var o = /n|\$|-|%/g, f = ""; ; ) {
                        var d = o.lastIndex,
                            p = o.exec(a);
                        if (((f += a.slice(d, p ? p.index : a.length)), !p))
                            break;
                        switch (p[0]) {
                            case "n":
                                f += u;
            ...
            (e = function (e, r) {
                ...
                (A = function (s, u, l) {
                        ...
                        if (w) {
                            ...
                            switch (C) {
                                ...
                                case "gg":
                                    ...
                                    T = h(T.toLowerCase());
                                    for (
                                        var j = 0, $ = i.eras.length;
                                        $ > j;
                                        j++
                                    )
                                        if (
                                            T === i.eras[j].name.toLowerCase()
                                        ) {
                                            g = j;
                                            break;
                                        }
                    ...
                    if (
                        ...
                        null === b
                            ? (b = P)
                            : i.eras && (b += i.eras[g || 0].offset),
                        null === m && (m = 0),
                        null === y && (y = 1),
                        E)
                    ) {
                        if (((G = E.toGregorian(b, m, y)), null === G))
                            return null;
                    } else {
                        if ((G.setFullYear(b, m, y), G.getDate() !== y))
                            return null;
            ...
            switch (t) {
                ...
                case "n-":
                    i(e, a)
                        ...
                        : i(e, s) &&
                          (n = ["+", e.substr(0, e.length - s.length)]);
                    break;
                case "- n":
                    (a += " "), (s += " ");
                case "-n":
        ...
        (t.addCultureInfo = function (e, r, t) {
            ...
            "string" != typeof e
                ...
                a &&
                    (this.cultures[e].calendar =
                        this.cultures[e].calendars.standard);
        }),
        ...
        (t.parseFloat = function (e, r, t) {
            ...
            if (
                (e.indexOf(u.numberFormat.currency.symbol) > -1 &&
                    ((e = e.replace(u.numberFormat.currency.symbol, "")),
                    (e = e.replace(
                ...
                0 > y
                    ? ((g = p), (b = null))
                    : ((g = p.substr(0, y)), (b = p.substr(y + m.length)));
                var M = i[","];
                g = g.split(M).join("");
                var v = M.replace(/\u00A0/g, " ");
        ...
        (t.culture = function (e) {
            return (
                "undefined" != typeof e && (this.cultureSelector = e),
