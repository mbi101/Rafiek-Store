    ...
    ($.app.menu = {
        ...
        manualScroller: {
            ...
            updateHeight: function () {
                ("vertical-menu" != $body.data("menu") &&
                    "vertical-menu-modern" != $body.data("menu") &&
                    "vertical-overlay-menu" != $body.data("menu")) ||
        ...
        init: function (compactMenu) {
            if ($(".main-menu-content").length > 0) {
                ...
                var defMenu = "";
                if (
                    (compactMenu === !0 && (defMenu = "collapsed"),
                    "vertical-menu-modern" == $body.data("menu"))
                ) {
                    var menuToggle = "";
        ...
        drillDownMenu: function (screenSize) {
            $(".drilldown-menu").length &&
                ("sm" == screenSize || "xs" == screenSize
                    ? "true" == $("#navbar-mobile").attr("aria-expanded") &&
                      $(".drilldown-menu").slidingMenu({ backLabel: !0 })
                    : $(".drilldown-menu").slidingMenu({ backLabel: !0 }));
        },
        change: function (defMenu) {
                ...
                $(input)
                    .change(function () {
                        ...
                        if (filter) {
                            ...
                            searchFilter.parent().hasClass("has-sub")
                                ? (searchFilter
                                      .show()
                                      .parents("li")
                                      .show()
                                      ...
                                      .children("li")
                                      .show(),
                                  searchFilter.siblings("ul").length > 0 &&
                                      searchFilter
                                          .siblings("ul")
                                          .children("li")
                                          .show()
            ...
            if (currentBreakpoint)
                switch (currentBreakpoint.name) {
                    case "xl":
                    case "lg":
                        "vertical-overlay-menu" === menuType
                            ? this.hide()
                            : "vertical-compact-menu" === menuType
                            ? this.open()
                            : "horizontal-menu" === menuType &&
                              "lg" == currentBreakpoint.name
                            ? this.collapse()
                            : "collapsed" === defMenu
            ...
            ("vertical-menu" !== menuType &&
                "vertical-compact-menu" !== menuType &&
                "vertical-content-menu" !== menuType &&
                "vertical-menu-modern" !== menuType) ||
                ...
                $(".header-navbar").hasClass("navbar-brand-center") &&
                    $(".header-navbar").attr("data-nav", "brand-center"),
                "sm" == currentBreakpoint.name || "xs" == currentBreakpoint.name
                ...
                $("ul.dropdown-menu [data-toggle=dropdown]").on(
                    "click",
                    function (event) {
                        $(this).siblings("ul.dropdown-menu").length > 0 &&
                ...
                "horizontal-menu" == menuType &&
                    ("sm" == currentBreakpoint.name ||
                    "xs" == currentBreakpoint.name
                        ? $(".menu-fixed").length && $(".menu-fixed").unstick()
                        : $(".navbar-fixed").length &&
                          $(".navbar-fixed").sticky()),
                ("vertical-menu" !== menuType &&
                    "vertical-overlay-menu" !== menuType &&
        ...
        transit: function (callback1, callback2) {
            ...
            $body.addClass("changing-menu"),
                ...
                $body.hasClass("vertical-layout") &&
                    ($body.hasClass("menu-open") ||
                    $body.hasClass("menu-expanded")
                        ? ($(".menu-toggle").addClass("is-active"),
                          ("vertical-menu" !== $body.data("menu") &&
                              "vertical-content-menu" !== $body.data("menu")) ||
                              ($(".main-menu-header") &&
        ...
        expand: function () {
            this.expanded === !1 &&
                ...
                this.transit(
                    ...
                    function () {
                        $(".main-menu").hasClass("menu-native-scroll") ||
                        "horizontal-menu" == $body.data("menu")
        ...
        toggle: function () {
            ...
            switch (currentBreakpoint.name) {
                ...
                case "md":
                    expanded === !0
                        ? "vertical-compact-menu" == menu ||
                          "vertical-overlay-menu" == menu
                            ? this.hide()
                            : this.collapse()
                        : "vertical-compact-menu" == menu ||
                          "vertical-overlay-menu" == menu
        ...
        ($.app.nav = {
            ...
            bind_events: function () {
                ...
                function modernMenuCollapse() {
                    $body.hasClass("menu-collapsed") &&
                        ...
                        setTimeout(function () {
                            if (
                                0 === $(".main-menu:hover").length &&
                                0 === $(".navbar-header:hover").length &&
                ...
                $(".navigation-main")
                    .on("mouseenter.app.menu", "li", function () {
                        var $this = $(this);
                        if (
                            ($(".hover", ".navigation-main").removeClass(
                                "hover"
                            ),
                            ($body.hasClass("menu-collapsed") &&
                                "vertical-menu-modern" != $body.data("menu")) ||
                    ...
                    .on("open.app.menu", "li", function (e) {
                        ...
                        return (
                            ...
                            !$(".main-menu").hasClass("menu-collapsible") &&
                                ($listItem
                                    .siblings(".open")
                                    .find("li.open")
                        ...
                        $listItem.is(".disabled")
                            ...
                            : ($body.hasClass("menu-collapsed") &&
                                  "vertical-menu-modern" !=
                                      $body.data("menu")) ||
                              ("vertical-compact-menu" == $body.data("menu") &&
                                  $listItem.is(".has-sub") &&
                                  !$body.hasClass("vertical-overlay-menu"))
                            ? e.preventDefault()
                            : $listItem.has("ul")
                    ...
                    $(".navigation-main li.has-sub > a").on(
                        "click",
                        function (e) {
                            e.preventDefault();
                        }
            ...
            adjustSubmenu: function ($menuItem) {
                ...
                (menuHeaderHeight = $(".main-menu-header").height()),
                    ...
                    parseInt($menuItem.css("border-top"), 10) > 0 &&
                        (borderWidth = parseInt(
                            $menuItem.css("border-top"),
                            10
                        )),
                    (popOutMenuHeight =
                        winHeight - menutop - $menuItem.height() - 30),
                    ...
                    "vertical-compact-menu" === $body.data("menu")
                        ...
                        : "vertical-content-menu" === $body.data("menu")
                        ? ((topPos =
                              menutop + $menuItem.height() + borderWidth),
                          (popOutMenuHeight =
                              winHeight -
                    ...
                    "vertical-content-menu" == $body.data("menu")
                        ...
                        : (ul
                          ...
                          ).perfectScrollbar({ theme: scroll_theme }));
            },
