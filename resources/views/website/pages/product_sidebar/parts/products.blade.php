        ...
        <div class="row g-5">
                ...
                <div class="product-wrapper" data-aos="fade-up">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-description">
                            <a href="{{ route('website.product_info') }}" class="product-details">Flower Design Skart
                            </a>
                            <div class="price">
            ...
            <div class="col-lg-12">
                <div class="product-deal-section" data-aos="fade-up">
                    ...
                    <a href="{{ route('website.seller_sidebar') }}" class="shop-btn">Shop Now</a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6">
                <div class="product-wrapper" data-aos="fade-up">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="product-wrapper" data-aos="fade-up">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-description">
                            <a href="{{ route('website.product_info') }}" class="product-details">Sleeveless Dress
                            </a>
                            <div class="price">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="product-wrapper" data-aos="fade-up">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-description">
                            <a href="{{ route('website.product_info') }}" class="product-details">Rainbow Sequin Shirt
                            </a>
                            <div class="price">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="product-wrapper" data-aos="fade-up">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-description">
                            <a href="{{ route('website.product_info') }}" class="product-details">Rainbow Baby Dress
                            </a>
                            <div class="price">
                                <span class="price-cut">$29.99</span>
                                <span class="new-price">$16.99</span>
