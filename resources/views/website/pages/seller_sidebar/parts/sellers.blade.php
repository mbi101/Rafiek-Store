                        ...
                        <div class="address email">
                            ...
                            <span class="inner-text">
                                <a href="https://quomodothemes.website/cdn-cgi/l/email-protection" class="__cf_email__"
                                   data-cfemail="5e3d3f3d3726376b6c6a691e3d312c27323f30703d3133">[email&#160;protected]</a>
                            </span>
                        </div>
            ...
            <div class="col-lg-3">
                <div class="sidebar" data-aos="fade-right">
                    ...
                    <div class="sidebar-shop-section">
                        ...
                        <a href="{{ route('website.product_sidebar') }}" class="shop-btn deal-btn">Shop Now </a>
                    </div>
                </div>
            </div>
            <div class="col-lg-9">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{ route('website.product_info') }}" class="product-details">Red Party Dress
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{ route('website.product_info') }}" class="product-details">Red Baby Dress
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{ route('website.product_info') }}" class="product-details">White T-Shirt
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{ route('website.product_info') }}" class="product-details">Blue Sleeveless Dress
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{ route('website.product_info') }}" class="product-details">Red Sleeveless Dress
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{ route('website.product_info') }}" class="product-details">Tom Checked Shirt
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{ route('website.product_info') }}" class="product-details">White Baby Hat
                                        </a>
                                        <div class="price">
