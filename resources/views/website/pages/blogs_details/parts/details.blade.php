                            ...
                            <div class="col-lg-12">
                                <div class="blog-post search">
                                    ...
                                    <div class="search-btn">
                                        ...
                                        <span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="#AE1C9A" xmlns="http://www.w3.org/2000/svg" class="fill-current">
                                                <path
                                    ...
                                    <div class="blogs-wrapper product-wrapper">
                                        ...
                                        <div class="wrapper-info">
                                            ...
                                            <div class="wrapper-data">
                                                <div class="admin wrapper-item">
                                                    <span class="icon">
                                                        <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg" class="fill-current">
                                                            <path
