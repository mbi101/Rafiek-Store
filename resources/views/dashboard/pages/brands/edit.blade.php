        ...
        <div class="content-wrapper">
            <div class="content-header">
                <x-dashboard.breadceumb :title="__('dashboard.dashboard')" :first_link_url="route('dashboard.home')" :second_link_title="__('dashboard.brands')" :second_link_url="route('dashboard.brands.index')"
                    :active="__('dashboard.brand_edit')" />
            </div>
            <div class="content-body">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h3 class="card-title" id="basic-layout-colored-form-control">{{ __('dashboard.brand_edit') }}
                        </h3>
                    </div>

                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="{{ route('dashboard.brands.update', $brand) }}" method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nameAr"
                                                    ...
                                                    value="{{ old('name.ar', $brand->name['ar']) }}">
                                                @error('name.ar')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nameEn"
                                                    ...
                                                    value="{{ old('name.en', $brand->name['en']) }}">
                                                @error('name.en')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            @if ($brand->image)
                                                <div class="form-group col-md-3">
                                                    <img src="{{ asset(str_starts_with($brand->image, 'assets/') ? $brand->image : 'storage/' . $brand->image) }}"
                                                        width="100%" loading="lazy" alt="brand image">
                                                </div>
                                            @endif
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="category_id" id="parent"
                                                    ...
                                                    @forelse ($categories as $cat)
                                                        <option value="{{ $cat->id }}" @selected($brand->category_id == $cat->id)>
                                                            @if (app()->getLocale() == 'ar')
                                                                {{ ucfirst($cat->name['ar']) }}
                                                            @else
                                                                {{ ucfirst($cat->name['en']) }}
                                                ...
                                                <div class="form-check form-switch d-flex justify-content-flex-start px-0 align-items-center gap-1 @if (app()->getLocale() == 'en') flex-row-reverse @endif"
                                                    ...
                                                    <p class="mx-1">
                                                        <input class="form-check-input switchery" type="checkbox"
                                                            ...
                                                            name="status" id="switchery" @checked($brand->status == 1)>
                                                    </p>
