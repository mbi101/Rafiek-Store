        ...
        <div class="content-wrapper">
            <div class="content-header">
                <x-dashboard.breadceumb
                    ...
                    :second_link_url="route('dashboard.countries.index')" :second_link_title="__('dashboard.countries_cities')" :active="__('dashboard.edit_city')"
                />
            </div>
            <div class="content-body">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h3 class="card-title" id="basic-layout-colored-form-control">{{ __('dashboard.edit_city') }} </h3>
                    </div>

                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="{{ route('dashboard.countries.cities.update', $city->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="shipping" class="form-control @error('shipping') is-invalid @enderror"
                                                       placeholder="{{ __('dashboard.shipping') }}" name="shipping" value="{{ old('shipping', $city->shipping) }}">
                                                @error('shipping')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                ...
                                <div class="form-actions right">
                                    <a href="{{ route('dashboard.countries.cities.index', $city->country->id) }}" class="btn btn-primary ms-3 round px-2 mr-1">
