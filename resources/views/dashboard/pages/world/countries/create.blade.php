        ...
        <div class="content-wrapper">
            <div class="content-header">
                <x-dashboard.breadceumb
                    ...
                    :second_link_url="route('dashboard.countries.index')" :second_link_title="__('dashboard.countries_cities')" :active="__('dashboard.create_country')"
                />
            </div>
            <div class="content-body">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h3 class="card-title" id="basic-layout-colored-form-control">{{ __('dashboard.create_country') }} </h3>
                    </div>

                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="{{ route('dashboard.countries.store') }}" method="POST">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="countryCode" class="form-control @error('code') is-invalid @enderror"
                                                       placeholder="{{ __('dashboard.country_code') }}" name="code" value="{{ old('code') }}">
                                                @error('code')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
