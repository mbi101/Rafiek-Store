<div {{ $attributes->merge(['class' => 'modal fade text-left animated slideInDown']) }} id="confirmDeleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <div class="modal-message  mt-2 font-weight-bold">{{ __('dashboard.delete_confirmation_content') }}</div>
            </div>
